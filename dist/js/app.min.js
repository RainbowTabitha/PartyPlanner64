...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};function _defineProperty(e,a,t){return a in e?Object.defineProperty(e,a,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[a]=t,e}PP64.interaction=function(){var r={},d=!1,u=-1,$=-1,E=-1,_=-1,S=null;function a(e){c(e.currentTarget,e.clientX,e.clientY,e.ctrlKey)}function t(e){if(1===e.touches.length){var a=e.touches[0];c(e.currentTarget,a.clientX,a.clientY,e.ctrlKey)}}function c(e,a,t,c){var r=a-(S=e.getBoundingClientRect()).left,n=t-S.top;u=E=r,$=_=n;var p=N(E,_);$$log("Clicked space: "+$$hex(p)+" ("+p+")",PP64.boards.getCurrentBoard().spaces[p]);var s=-1!==p;PP64.boards.currentBoardIsROM()&&s&&(PP64.app.changeCurrentAction($actType.MOVE),PP64.boards.copyCurrentBoard(),PP64.boards.setCurrentBoard(PP64.boards.getCurrentBoardIndex()+1));var T=PP64.app.getCurrentAction();switch(T){case $actType.MOVE:s?c?M(p):g(p)||I(p):O();break;case $actType.ADD_OTHER:case $actType.ADD_BLUE:case $actType.ADD_RED:case $actType.ADD_MINIGAME:case $actType.ADD_HAPPENING:case $actType.ADD_STAR:case $actType.ADD_BLACKSTAR:case $actType.ADD_START:case $actType.ADD_CHANCE:case $actType.ADD_SHROOM:case $actType.ADD_BOWSER:case $actType.ADD_ITEM:case $actType.ADD_BATTLE:case $actType.ADD_BANK:case $actType.ADD_GAMEGUY:case $actType.ADD_ARROW:case $actType.MARK_STAR:case $actType.MARK_GATE:case $actType.ADD_TOAD_CHARACTER:case $actType.ADD_BOWSER_CHARACTER:case $actType.ADD_KOOPA_CHARACTER:case $actType.ADD_BOO_CHARACTER:case $actType.ADD_BANK_SUBTYPE:case $actType.ADD_BANKCOIN_SUBTYPE:case $actType.ADD_ITEMSHOP_SUBTYPE:s?c?M(p):g(p)||I(p):c||O();break;case $actType.LINE:case $actType.LINE_STICKY:s?I(p):O();break;case $actType.ERASE:O()}var A=B(),o=PP64.boards.getCurrentBoard(),D=o.spaces[p];switch(T){case $actType.LINE:if(1===A.length){var y=A[0];PP64.renderer.renderConnections(),PP64.renderer.drawConnection(y.x,y.y,r,n),PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(null)}break;case $actType.LINE_STICKY:if(1===A.length){var P=A[0];if(D&&D!==P){var i=PP64.boards.getSpaceIndex(P,o);PP64.boards.addConnection(i,p),I(p),PP64.renderer.renderConnections()}else PP64.renderer.renderConnections(),PP64.renderer.drawConnection(P.x,P.y,r,n)}break;case $actType.ERASE:-1!==p&&m(o,p)?(PP64.boards.removeSpace(p),PP64.app.changeSelectedSpaces([]),PP64.renderer.render()):H(r,n);break;case $actType.ADD_OTHER:case $actType.ADD_BLUE:case $actType.ADD_RED:case $actType.ADD_MINIGAME:case $actType.ADD_HAPPENING:case $actType.ADD_STAR:case $actType.ADD_BLACKSTAR:case $actType.ADD_START:case $actType.ADD_CHANCE:case $actType.ADD_SHROOM:case $actType.ADD_BOWSER:case $actType.ADD_ITEM:case $actType.ADD_BATTLE:case $actType.ADD_BANK:case $actType.ADD_GAMEGUY:case $actType.ADD_ARROW:case $actType.MARK_STAR:case $actType.MARK_GATE:case $actType.ADD_TOAD_CHARACTER:case $actType.ADD_BOWSER_CHARACTER:case $actType.ADD_KOOPA_CHARACTER:case $actType.ADD_BOO_CHARACTER:case $actType.ADD_BANK_SUBTYPE:case $actType.ADD_BANKCOIN_SUBTYPE:case $actType.ADD_ITEMSHOP_SUBTYPE:L(T,r,n,D,!1,c)&&M(-1!==p?p:o.spaces.length-1);break;case $actType.MOVE:default:d=s,PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(A[0])}}function n(e){if(1===e.touches.length&&b()){e.preventDefault();var a=e.touches[0];s(a.clientX-S.left,a.clientY-S.top)}}function p(e){S&&1===e.buttons&&s(e.clientX-S.left,e.clientY-S.top)}function s(e,a){if(!PP64.boards.currentBoardIsROM()){var t=PP64.app.getCurrentAction(),c=B(),r=PP64.boards.getCurrentBoard(),n=N(e,a);switch(t){case $actType.LINE:if(1===c.length){var p=c[0];PP64.renderer.renderConnections(),PP64.renderer.drawConnection(p.x,p.y,e,a),PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(null)}break;case $actType.LINE_STICKY:if(1===c.length){var s=c[0],T=r.spaces[n];if(T&&T!==s){var A=PP64.boards.getSpaceIndex(s,r);PP64.boards.addConnection(A,n),I(n),PP64.renderer.renderConnections()}else PP64.renderer.renderConnections(),PP64.renderer.drawConnection(s.x,s.y,e,a)}break;case $actType.ERASE:-1!==n&&m(r,n)?(PP64.boards.removeSpace(n),PP64.app.changeSelectedSpaces([]),PP64.renderer.render()):H(e,a);break;case $actType.MOVE:case $actType.ADD_OTHER:case $actType.ADD_BLUE:case $actType.ADD_RED:case $actType.ADD_MINIGAME:case $actType.ADD_HAPPENING:case $actType.ADD_STAR:case $actType.ADD_BLACKSTAR:case $actType.ADD_START:case $actType.ADD_CHANCE:case $actType.ADD_SHROOM:case $actType.ADD_BOWSER:case $actType.ADD_ITEM:case $actType.ADD_BATTLE:case $actType.ADD_BANK:case $actType.ADD_GAMEGUY:case $actType.ADD_ARROW:case $actType.MARK_STAR:case $actType.MARK_GATE:case $actType.ADD_TOAD_CHARACTER:case $actType.ADD_BOWSER_CHARACTER:case $actType.ADD_KOOPA_CHARACTER:case $actType.ADD_BOO_CHARACTER:case $actType.ADD_BANK_SUBTYPE:case $actType.ADD_BANKCOIN_SUBTYPE:case $actType.ADD_ITEMSHOP_SUBTYPE:default:var o=!d&&t===$actType.MOVE;if(!o&&c.length){var D=e-E,y=a-_;c.forEach(function(e){var a=e.x+D;e.x=Math.max(0,Math.min(a,r.bg.width));var t=e.y+y;e.y=Math.max(0,Math.min(t,r.bg.height))}),l||(l=setTimeout(C,10)),f||(f=setTimeout(v,10)),PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(c[0])}o&&function(e,a){if(-1===u||-1===$)return;O();for(var t=PP64.boards.getCurrentBoard().spaces,c=0;c<t.length;c++){var r=t[c];$$number.pointFallsWithin(r.x,r.y,u,$,e,a)&&M(c,!0)}h(),PP64.renderer.drawSelectionBox(u,$,e,a)}(e,a)}E=e,_=a}}function T(e){0===e.button&&o()}function A(e){1===e.touches.length&&o()}function o(){if(!PP64.boards.currentBoardIsROM()){var e=PP64.app.getCurrentAction();if(d||e!==$actType.MOVE||PP64.renderer.renderSpaces(),b()){var a=B();if(e===$actType.LINE){var t=N(E,_);if(-1!==t&&-1===a.indexOf(t))for(var c in r)PP64.boards.addConnection(parseInt(c),t);PP64.renderer.renderConnections()}}}}function D(e){if(!PP64.boards.currentBoardIsROM()){var a=5<Math.abs(u-E)||5<Math.abs($-_),t=0<Math.abs(u-E)||0<Math.abs($-_),c=B();u=E=-1,$=_=-1;var r=e.ctrlKey,n=N(e.clientX-S.left,e.clientY-S.top),p=PP64.boards.getCurrentBoard(),s=-1===n?null:p.spaces[n];if(0===e.button)switch(PP64.app.getCurrentAction()){case $actType.MOVE:case $actType.ADD_OTHER:case $actType.ADD_BLUE:case $actType.ADD_RED:case $actType.ADD_MINIGAME:case $actType.ADD_HAPPENING:case $actType.ADD_STAR:case $actType.ADD_BLACKSTAR:case $actType.ADD_START:case $actType.ADD_CHANCE:case $actType.ADD_SHROOM:case $actType.ADD_BOWSER:case $actType.ADD_ITEM:case $actType.ADD_BATTLE:case $actType.ADD_BANK:case $actType.ADD_GAMEGUY:case $actType.ADD_ARROW:case $actType.MARK_GATE:case $actType.ADD_TOAD_CHARACTER:case $actType.ADD_BOWSER_CHARACTER:case $actType.ADD_KOOPA_CHARACTER:case $actType.ADD_BOO_CHARACTER:case $actType.ADD_BANK_SUBTYPE:case $actType.ADD_BANKCOIN_SUBTYPE:case $actType.ADD_ITEMSHOP_SUBTYPE:t||r||(s?I(n):O());break;case $actType.MARK_STAR:a||function(e){if(!e||!e.length)return;e.forEach(function(e){e.star=!e.star}),PP64.renderer.renderSpaces(),PP64.app.changeSelectedSpaces(e)}(c);break;case $actType.LINE:case $actType.LINE_STICKY:PP64.renderer.renderConnections();break;case $actType.ERASE:}}}function y(e){e.preventDefault(),e.stopPropagation();var a=B(),t=1!==a.length?null:a[0];PP64.renderer.updateRightClickMenu(t)}function P(e){if(e.preventDefault(),!PP64.boards.currentBoardIsROM()){PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(null);var a=void 0;try{a=JSON.parse(e.dataTransfer.getData("text"))}catch(e){return}if(O(),"object"===(void 0===a?"undefined":_typeof(a))&&a.action){var t=e.currentTarget;S=t.getBoundingClientRect();var c=e.clientX-S.left,r=e.clientY-S.top,n=N(c,r),p=PP64.boards.getCurrentBoard(),s=-1===n?null:p.spaces[n];L(a.action.type,c,r,s,!1,!1)}}}function i(e){var a=PP64.app.getSelectedSpaces();if(a&&a.length){var t=PP64.boards.getCurrentBoard();if(38===e.keyCode)a.forEach(function(e){e.y=Math.max(e.y-1,0)}),PP64.app.changeSelectedSpaces(a);else if(40===e.keyCode)a.forEach(function(e){e.y=Math.min(e.y+1,t.bg.height)}),PP64.app.changeSelectedSpaces(a);else if(37===e.keyCode)a.forEach(function(e){e.x=Math.max(e.x-1,0)}),PP64.app.changeSelectedSpaces(a);else if(39===e.keyCode)a.forEach(function(e){e.x=Math.min(e.x+1,t.bg.width)}),PP64.app.changeSelectedSpaces(a);else if(46===e.keyCode){var c=!1;a.forEach(function(e){void 0!==e.subtype&&(c=!0)}),a.forEach(function(e){if(c)void 0!==e.subtype&&delete e.subtype;else{var a=PP64.boards.getSpaceIndex(e,t);m(t,a)&&PP64.boards.removeSpace(a,t)}}),c?PP64.app.changeSelectedSpaces(a):PP64.app.changeSelectedSpaces([])}}}function R(e){if(0===e.button&&!PP64.boards.currentBoardIsROM()){var a=PP64.app.getCurrentAction();!d&&a===$actType.MOVE&&(PP64.renderer.renderSpaces(),u=E=-1,$=_=-1)}}var l=void 0;function C(){PP64.renderer.renderConnections(),l=null}var f=void 0;function v(){PP64.renderer.renderSpaces(),PP64.renderer.renderSelectedSpaces(),f=null}function O(){r={},PP64.app.changeSelectedSpaces([])}function h(){PP64.app.changeSelectedSpaces(B())}function B(){var e=PP64.boards.getCurrentBoard(),a=[];for(var t in r){var c=e.spaces[t];a.push(c)}return a}function b(){for(var e in r)return!0;return!1}function g(e){return!!r[e]}function M(e,a){r||(r={}),r[e]=!0,a||h()}function I(e){r=_defineProperty({},e,!0),h()}function N(e,a){for(var t=PP64.boards.getCurrentBoard(),c=3===PP64.boards.getCurrentBoard().game?14:8,r=-1,n=0;n<t.spaces.length;n++){var p=t.spaces[n];p&&(Math.abs(p.x-e)<=c&&Math.abs(p.y-a)<=c&&(r=n))}return r}function m(e,a){var t=e.spaces[a];return!!t&&(t.type!==$spaceType.START||1<PP64.boards.getSpacesOfType($spaceType.START,e).length)}function L(e,a,t,c,r,n){var p=function(e){var a=$spaceType.OTHER;e===$actType.ADD_BLUE?a=$spaceType.BLUE:e===$actType.ADD_RED?a=$spaceType.RED:e===$actType.ADD_HAPPENING?a=$spaceType.HAPPENING:e===$actType.ADD_STAR?a=$spaceType.STAR:e===$actType.ADD_BLACKSTAR?a=$spaceType.BLACKSTAR:e===$actType.ADD_MINIGAME?a=$spaceType.MINIGAME:e===$actType.ADD_CHANCE?a=$spaceType.CHANCE:e===$actType.ADD_START?a=$spaceType.START:e===$actType.ADD_SHROOM?a=$spaceType.SHROOM:e===$actType.ADD_BOWSER?a=$spaceType.BOWSER:e===$actType.ADD_ITEM?a=$spaceType.ITEM:e===$actType.ADD_BATTLE?a=$spaceType.BATTLE:e===$actType.ADD_BANK?a=$spaceType.BANK:e===$actType.ADD_ARROW?a=$spaceType.ARROW:e===$actType.ADD_GAMEGUY&&(a=$spaceType.GAMEGUY);return a}(e),s=function(e){var a=void 0;e===$actType.ADD_TOAD_CHARACTER?a=$spaceSubType.TOAD:e===$actType.ADD_BOWSER_CHARACTER?a=$spaceSubType.BOWSER:e===$actType.ADD_KOOPA_CHARACTER?a=$spaceSubType.KOOPA:e===$actType.ADD_BOO_CHARACTER?a=$spaceSubType.BOO:e===$actType.ADD_BANK_SUBTYPE?a=$spaceSubType.BANK:e===$actType.ADD_BANKCOIN_SUBTYPE?a=$spaceSubType.BANKCOIN:e===$actType.ADD_ITEMSHOP_SUBTYPE?a=$spaceSubType.ITEMSHOP:e===$actType.MARK_GATE&&(a=$spaceSubType.GATE);return a}(e),T=!1;if(c)void 0===s||r||(c.type!==$spaceType.OTHER&&s===$spaceSubType.GATE||(c.subtype===s?delete c.subtype:c.subtype=s),PP64.app.changeSelectedSpaces([c]),T=!0);else{var A=PP64.boards.getCurrentBoard(),o=PP64.boards.addSpace(a,t,p,s),D=A.spaces[o];if(n){var y=PP64.app.getSelectedSpaces()||[];y.push(D),PP64.app.changeSelectedSpaces(y)}else PP64.app.changeSelectedSpaces([D]);T=!0}return PP64.renderer.renderSpaces(),T}function H(e,a){var t=PP64.boards.getCurrentBoard(),c=t.spaces,r=t.links,n=!1;for(var p in r){var s=c[p],T=r[p];if(Array.isArray(T)){for(var A=0;A<T.length;)K(s,c[T[A]],e,a)?(T.splice(A,1),n=!0):A++;1===T.length?T=T[0]:T.length||delete r[p]}else K(s,c[T],e,a)&&(delete r[p],n=!0)}n&&PP64.renderer.renderConnections()}function K(e,a,t,c){return!(t>e.x&&t>a.x)&&(!(t<e.x&&t<a.x)&&(!(c>e.y&&c>a.y)&&(!(c<e.y&&c<a.y)&&$$number.lineDistance(t,c,e.x,e.y,a.x,a.y)<=4)))}function k(e){e.preventDefault()}return{attachToCanvas:function(e){e.addEventListener("contextmenu",y,!1),e.addEventListener("click",D,!1),e.addEventListener("mousedown",a,!1),e.addEventListener("mousemove",p,!1),e.addEventListener("mouseup",T,!1),e.addEventListener("mouseout",R,!1),e.addEventListener("touchstart",t,!1),e.addEventListener("touchmove",n,!1),e.addEventListener("touchend",A,!1),e.addEventListener("drop",P,!1),e.addEventListener("dragover",k,!1),e.addEventListener("keydown",i,!1)},detachFromCanvas:function(e){e.removeEventListener("contextmenu",y),e.removeEventListener("click",D),e.removeEventListener("mousedown",a),e.removeEventListener("mousemove",p),e.removeEventListener("mouseup",T),e.removeEventListener("mouseout",R),e.removeEventListener("touchstart",t),e.removeEventListener("touchmove",n),e.removeEventListener("touchend",A),e.removeEventListener("drop",P),e.removeEventListener("dragover",k),e.removeEventListener("keydown",i)}}}();
