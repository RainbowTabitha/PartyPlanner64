...
"use strict";var _slicedToArray=function(){function e(e,t){var n=[],a=!0,r=!1,s=void 0;try{for(var i,o=e[Symbol.iterator]();!(a=(i=o.next()).done)&&(n.push(i.value),!t||n.length!==t);a=!0);}catch(e){r=!0,s=e}finally{try{!a&&o.return&&o.return()}finally{if(r)throw s}}return n}return function(t,n){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();PP64.ns("adapters.events"),PP64.adapters.events.MP3=function(){var e=PP64.utils.arrays.hashEqual,t=PP64.adapters.events.EventCache,n=PP64.adapters.events.getEvent("CHAINMERGE");n._parse3=function(a,r){var s={START:"16092DD153432852C141C78807ECCBF0",END:"0855E7309F121915D7A762AB85A7FDB6"},i=[201569894,201597703],o=void 0,f=void 0;if(e([a.buffer,r.offset,8],s.START)&&i.indexOf(a.getUint32(r.offset+16))>=0&&e([a.buffer,r.offset+24,8],s.END)){if(o=a.getUint16(r.offset+14),o=o>1e3?0:o,f=0===a.getUint16(r.offset+20)?r.chains[o][0]:r.chains[o][a.getUint16(r.offset+22)],!isNaN(f)){if(r.board.links.hasOwnProperty(r.curSpace))return!1;PP64.boards.addConnection(r.curSpace,f,r.board)}var d=t.get(n.id)||{};if(!d[r.game]){d[r.game]={asm:a.buffer.slice(r.offset,r.offset+36)};var u=new DataView(d[r.game].asm);u.setUint32(8,0),u.setUint32(12,0),u.setUint32(20,0),t.set(n.id,d)}return!0}return!1};var a=PP64.adapters.events.getEvent("CHAINSPLIT");a._parse3=function(n,r){var s={METHOD_START:"16092DD153432852C141C78807ECCBF0",METHOD_END:"6FF6DF70CDC85862F8F129303009A544"};if(e([n.buffer,r.offset,8],s.METHOD_START)&&e([n.buffer,r.offset+36,20],s.METHOD_END)){var i=n.getUint16(r.offset+10)<<16,o=n.getUint16(r.offset+14),f=2147483647&(i|o);32768&f&&(f-=65536);for(var d=r.offset-(r.addr-f),u=n.getUint16(d);65535!==u;)PP64.boards.addConnection(r.curSpace,u,r.board),d+=2,u=n.getUint16(d);var I=t.get(a.id);if(I||(I={}),I[r.game]||(I[r.game]={}),!I[r.game].asm){I[r.game].asm=n.buffer.slice(r.offset,r.offset+56);var c=new DataView(I[r.game].asm);c.setUint32(8,0),c.setUint32(12,0),c.setUint32(16,0),c.setUint32(20,0),c.setUint32(24,0),c.setUint32(32,0)}return t.set(a.id,I),!0}return!1},a._write3=function(e,n,r,s){var i=t.get(a.id);if(!i||!i[r.game]||!i[r.game].asm)throw"Cannot write "+a.id+", missing cache entry values.";var o=i[r.game].asm;PP64.utils.arrays.copyRange(e,o,0,0,o.byteLength);var f=$MIPS.getRegSetUpperAndLower(r.argsAddr),d=_slicedToArray(f,2),u=d[0],I=d[1];e.setUint32(8,$MIPS.makeInst("LUI",$MIPS.REG.A0,u)),e.setUint32(12,$MIPS.makeInst("ADDIU",$MIPS.REG.A0,$MIPS.REG.A0,I));var c=$MIPS.getRegSetUpperAndLower(r.argsAddr+20),g=_slicedToArray(c,2);return u=g[0],I=g[1],e.setUint32(16,$MIPS.makeInst("LUI",$MIPS.REG.A1,u)),e.setUint32(20,$MIPS.makeInst("ADDIU",$MIPS.REG.A1,$MIPS.REG.A1,I)),e.setUint32(24,$MIPS.makeInst("LUI",$MIPS.REG.A2,32786)),e.setUint32(32,$MIPS.makeInst("ADDIU",$MIPS.REG.A2,$MIPS.REG.A2,54888)),n._reverse&&(e.setUint32(36,0),e.setUint32(40,0)),[r.offset,o.byteLength]};var r=PP64.adapters.events.createEvent("REVERSECHAINSPLIT","");r.fakeEvent=!0,r.activationType=$activationType.WALKOVER,r.mystery=1,r.supportedGameVersions=[3],r.supportedGames=[$gameType.MP3_USA],r.parse=function(n,a){var s={REVERSE_FILTER:"0909C95D982B8A9B1F096AC54FFFB816"};if(!e([n.buffer,a.offset,48],s.REVERSE_FILTER))return!1;var i=(n.getUint32(a.offset+48),t.get(r.id)||{});if(!i[a.game]){i[a.game]={asm:n.buffer.slice(a.offset,a.offset+$MIPS.getFunctionLength(n,a.offset))};new DataView(i[a.game].asm);t.set(r.id,i)}return!0},r.write=function(e,n,s,i){var o=t.get(r.id);if(!o||!o[s.game]||!o[s.game].asm)throw"Cannot write "+r.id+", missing cache entry values.";n._reverse=!0;var f=a._write3(e,n,s,i),d=_slicedToArray(f,2),u=(d[0],d[1]),I=o[s.game].asm;PP64.utils.arrays.copyRange(e,I,u,0,I.byteLength);var c=2147483647&s.addr;return e.setUint32(u+48,$MIPS.makeInst("JAL",c)),[s.offset+u,u+I.byteLength]};var s=PP64.adapters.events.getEvent("STAR");s._parse3=function(t,n){var a={CHILLY:"E9B6C28983AAE724AC187EA8E0CBC79D"};return!!e([t.buffer,n.offset,956],a.CHILLY)},s._write3=function(e,t,n,a){return[3276836,0]};var i=PP64.adapters.events.getEvent("BOO");i._parse3=function(e,t){var n=void 0,a=!1;if(0===t.boardIndex){if(3291628!==t.offset)return!1;if(201568050!==e.getUint32(t.offset+76))return!1;n=$MIPS.getFunctionLength(e,t.offset),a=4564===n}return!!a},i._write3=function(e,t,n,a){if(0===n.boardIndex){var r=PP64.romhandler.getDataView();r.setUint16(3291818,n.curSpaceIndex);for(var s=PP64.boards.getSpacesOfSubType($spaceSubType.BOO,n.board),i=n.curSpace,o=Number.MAX_VALUE,f=n.board._deadSpace,d=0;d<s.length;d++){var u=s[d],I=n.board.spaces[u],c=PP64.utils.number.distance(i.x,i.y,I.x,I.y);c<o&&(o=c,f=u)}return r.setUint16(3291946,f),r.setUint16(3291958,f),[3291628,0]}throw"Can't write Boo to board index "+n.boardIndex};var o=PP64.adapters.events.getEvent("BANK");o._parse3=function(t,n){var a={CHILLY:"FCA0025616E8B2BE4CD60F47EE60DC30"};return!!e([t.buffer,n.offset,180],a.CHILLY)},o._write3=function(e,t,n,a){var r=a.curBank=a.curBank||1;a.curBank++;for(var s=PP64.boards.getSpacesOfSubType($spaceSubType.BANK,n.board),i=n.curSpace,o=Number.MAX_VALUE,f=n.board._deadSpace,d=0;d<s.length;d++){var u=s[d],I=n.board.spaces[u],c=PP64.utils.number.distance(i.x,i.y,I.x,I.y);c<o&&(o=c,f=u)}if(0===n.boardIndex){var g=PP64.romhandler.getDataView();return 1===r?(g.setUint16(3277914,n.curSpaceIndex),g.setUint16(3277994,n.curSpaceIndex),g.setUint16(3277978,f),g.setUint16(3277986,f)):2===r&&(g.setUint16(3277922,n.curSpaceIndex),g.setUint16(3277962,n.curSpaceIndex),g.setUint16(3277942,f),g.setUint16(3277950,f)),[3277776,0]}throw"Can't write Bank to board index "+n.boardIndex};var f=PP64.adapters.events.getEvent("ITEMSHOP");f._parse3=function(e,t){var n=!1;if(0===t.boardIndex){if(3281356!==t.offset)return!1;if(201574479!==e.getUint32(t.offset+68))return!1;n=!0}return!!n},f._write3=function(e,t,n,a){var r=a.curItemShop=a.curItemShop||1;a.curItemShop++;for(var s=PP64.boards.getSpacesOfSubType($spaceSubType.ITEMSHOP,n.board),i=n.curSpace,o=Number.MAX_VALUE,f=n.board._deadSpace,d=0;d<s.length;d++){var u=s[d],I=n.board.spaces[u],c=PP64.utils.number.distance(i.x,i.y,I.x,I.y);c<o&&(o=c,f=u)}if(0===n.boardIndex){var g=PP64.romhandler.getDataView(),P=3281356;return 1===r?(g.setUint16(P+162,n.curSpaceIndex),g.setUint16(P+214,n.curSpaceIndex),g.setUint16(P+190,f),g.setUint16(P+202,f)):2===r&&(g.setUint16(P+170,n.curSpaceIndex),g.setUint16(P+254,n.curSpaceIndex),g.setUint16(P+178,f),g.setUint16(P+242,f)),[P,0]}throw"Can't write Item Shop to board index "+n.boardIndex};var d=PP64.adapters.events.getEvent("GATE");d._parse3=function(e,t){if(0===t.boardIndex){if(3274312!==t.offset)return!1;if(e.getUint16(t.offset+98)===t.curSpaceIndex)return t.board.spaces[e.getUint16(t.offset+262)].subtype=$spaceSubType.GATE,!0;if(e.getUint16(t.offset+106)===t.curSpaceIndex)return t.board.spaces[e.getUint16(t.offset+270)].subtype=$spaceSubType.GATE,!0}return!1},d._write3=function(e,t,n,a){var r=[3274312],s=r[n.boardIndex];if(n.curSpaceIndex!==t.gateEntryIndex)return[s,0];var i=a.curGate=a.curGate||1;if(a.curGate++,console.log("temp.curGate "+a.curGate),0===n.boardIndex){var o=PP64.romhandler.getDataView();return 1===i?(o.setUint16(3275130,t.gatePrevChain[0]),o.setUint32(3275136,$MIPS.makeInst("ADDIU",$MIPS.REG.A2,$MIPS.REG.R0,t.gatePrevChain[1])),o.setUint16(s+98,t.gateEntryIndex),o.setUint16(s+238,t.gateEntryIndex),o.setUint16(s+554,t.gateEntryIndex),o.setUint16(s+806,t.gateEntryIndex),o.setUint32(3274836,$MIPS.makeInst("ADDIU",$MIPS.REG.V0,$MIPS.REG.R0,t.gateEntryIndex)),o.setUint32(3274840,$MIPS.makeInst("BEQ",$MIPS.REG.S1,$MIPS.REG.V0,20)),o.setUint32(3275088,$MIPS.makeInst("ADDIU",$MIPS.REG.V0,$MIPS.REG.R0,t.gateEntryIndex)),o.setUint32(3275092,$MIPS.makeInst("BEQ",$MIPS.REG.S1,$MIPS.REG.V0,20)),o.setUint16(s+262,t.gateSpaceIndex),o.setUint16(s+122,t.gateExitIndex),o.setUint16(s+230,t.gateExitIndex),o.setUint16(s+534,t.gateExitIndex),o.setUint16(s+786,t.gateExitIndex),o.setUint16(3275106,t.gateNextChain[0]),o.setUint16(3275158,t.gateNextChain[1])):2===i&&(o.setUint16(3275162,t.gatePrevChain[0]),o.setUint16(3275170,t.gatePrevChain[1]),o.setUint16(s+106,t.gateEntryIndex),o.setUint16(s+518,t.gateEntryIndex),o.setUint16(s+766,t.gateEntryIndex),o.setUint16(s+270,t.gateSpaceIndex),o.setUint16(s+146,t.gateExitIndex),o.setUint16(3275114,t.gateNextChain[0]),o.setUint16(3275190,t.gateNextChain[1]),o.setUint16(3275186,t.gateNextChain[0])),[s,0]}throw"Can't write Gate to board index "+n.boardIndex};var u=PP64.adapters.events.getEvent("GATECLOSE");u._parse3=function(e,n){var a=$MIPS.getFunctionLength(e,n.offset);if(28!==a)return!1;var r=[201597626];if(e.getUint32(n.offset+8)!==r[n.boardIndex])return!1;var s=t.get(u.id);return s||(s={}),s[n.game]||(s[n.game]={}),s[n.game][n.boardIndex]||(s[n.game][n.boardIndex]={}),s[n.game][n.boardIndex].asm||(s[n.game][n.boardIndex].asm=e.buffer.slice(n.offset,n.offset+a)),t.set(u.id,s),!0},u._write3=function(e,n,a,r){var s=t.get(u.id);if(!s||!s[a.game]||!s[a.game][a.boardIndex])throw"Cannot write "+u.id+", missing cache entry.";var i=s[a.game][a.boardIndex].asm;return PP64.utils.arrays.copyRange(e,i,0,0,i.byteLength),e.setUint32(12,$MIPS.makeInst("ADDIU",$MIPS.REG.A0,$MIPS.REG.R0,n.gateIndex)),[a.offset,i.byteLength]}}();
