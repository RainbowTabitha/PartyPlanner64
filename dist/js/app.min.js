...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,a,r){return a&&e(t.prototype,a),r&&e(t,r),t}}();PP64.about={About:function(e){function t(){var e,a,r,n;_classCallCheck(this,t);for(var l=arguments.length,c=Array(l),o=0;o<l;o++)c[o]=arguments[o];return a=r=_possibleConstructorReturn(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(c))),r.state={},n=a,_possibleConstructorReturn(r,n)}return _inherits(t,React.Component),_createClass(t,[{key:"render",value:function(){var e="v0.3.2-beta (+87 <a href='https://github.com/PartyPlanner64/PartyPlanner64/commit/24c6f62'>24c6f62</a>)";e==="####VERS ION####".replace(" ","")&&(e="unknown");var t=void 0;return t=document.location.href.indexOf("mariopartylegacy")>=0?"Hosted by":"Visit",React.createElement("div",{id:"aboutForm"},React.createElement("div",{className:"aboutHeader"},React.createElement("img",{src:"img/logoloading.png",alt:"PartyPlanner64"}),React.createElement("br",null),React.createElement("span",{className:"aboutVersion selectable"},"Version ",React.createElement("span",{dangerouslySetInnerHTML:{__html:e}}))),React.createElement("br",null),React.createElement("div",{className:"aboutText"},React.createElement("span",{className:"aboutTextLabel"},"Want more PartyPlanner64?"),React.createElement("ul",null,React.createElement("li",null,"Follow ",React.createElement("a",{href:"https://twitter.com/PartyPlanner64",target:"_blank"},"@PartyPlanner64")," on Twitter."),React.createElement("li",null,React.createElement("a",{href:"https://github.com/PartyPlanner64/PartyPlanner64",target:"_blank"},"Contribute")," to development on Github."),React.createElement("li",null,"Write or view ",React.createElement("a",{href:"https://github.com/PartyPlanner64/PartyPlanner64/issues",target:"_blank"},"bugs and enhancement requests"),"."),React.createElement("li",null,"Read the ",React.createElement("a",{href:"https://github.com/PartyPlanner64/PartyPlanner64/wiki/Creating-a-Board"},"usage tutorial")," or ",React.createElement("a",{href:"https://github.com/PartyPlanner64/PartyPlanner64/wiki"},"documentation"),"."))),React.createElement("br",null),React.createElement("br",null),React.createElement("div",{className:"aboutHeader"},React.createElement("span",null,t),React.createElement("br",null),React.createElement("a",{href:"http://mariopartylegacy.com/",target:"_blank"},React.createElement("img",{src:"img/mpllogo.png",alt:"Mario Party Legacy"}))),React.createElement("div",{className:"aboutText"},React.createElement("ul",null,React.createElement("li",null,"Check out discussion in the ",React.createElement("a",{href:"http://www.mariopartylegacy.com/forum/index.php?topic=15883.0",target:"_blank"},"forum thread"),"."),React.createElement("li",null,"Post your creations to the ",React.createElement("a",{href:"http://www.mariopartylegacy.com/forum/index.php?action=downloads",target:"_blank"},"downloads page"),"."))),React.createElement("br",null),React.createElement("br",null),React.createElement("span",{className:"aboutDisclaimer"},"PartyPlanner64 is not affiliated with Nintendo or Hudson."),React.createElement("br",null),React.createElement("span",{className:"aboutDisclaimer"},"Mario Party is a registered trademark of Nintendo."))}}]),t}()};
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _slicedToArray=function(){return function(e,t){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return function(e,t){var r=[],o=!0,s=!1,n=void 0;try{for(var a,l=e[Symbol.iterator]();!(o=(a=l.next()).done)&&(r.push(a.value),!t||r.length!==t);o=!0);}catch(e){s=!0,n=e}finally{try{!o&&l.return&&l.return()}finally{if(s)throw n}}return r}(e,t);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var o=t[r];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,r,o){return r&&e(t.prototype,r),o&&e(t,o),t}}();PP64.models=function(){var e=function(e){function t(e){_classCallCheck(this,t);var r=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));r.onModelSelected=function(e){var t=e.match(/^(\d+)\/(\d+)/);if(!t)throw"Could not parse selected model string "+r.props.selectedModel;var o=_slicedToArray(t,3),s=o[1],n=o[2];r.setState({selectedModel:e,selectedModelDir:s,selectedModelFile:n,selectedAnim:"",selectedAnimDir:null,selectedAnimFile:null})},r.onAnimSelected=function(e){if(e){var t=e.match(/^(\d+)\/(\d+)/);if(!t)throw"Error parsing anim string "+e;var o=_slicedToArray(t,3),s=o[1],n=o[2];r.setState({selectedAnim:e,selectedAnimDir:s,selectedAnimFile:n})}else r.setState({selectedAnim:"",selectedAnimDir:null,selectedAnimFile:null})},r.onBgColorChange=function(e){r.setState({bgColor:e})},r.onFeatureChange=function(e){r.setState(e)},r.state={selectedModel:"",selectedModelDir:null,selectedModelFile:null,selectedAnim:"",selectedAnimDir:null,selectedAnimFile:null,bgColor:0,showTextures:!0,showWireframe:!1,showVertexNormals:!1,useCamera:!1};for(var o=PP64.fs.mainfs.getDirectoryCount(),s=2;s<o;s++)for(var n=PP64.fs.mainfs.getFileCount(s),a=0;a<n;a++){var l=PP64.fs.mainfs.get(s,a);if(PP64.utils.FORM.isForm(l)){var i=s+"/"+a;return r.state.selectedModel=i,r.state.selectedModelDir=s,r.state.selectedModelFile=a,_possibleConstructorReturn(r)}}return r}return _inherits(t,React.Component),_createClass(t,[{key:"render",value:function(){return React.createElement("div",{className:"modelViewerContainer"},React.createElement(c,{selectedModel:this.state.selectedModel,onModelSelected:this.onModelSelected,selectedModelDir:this.state.selectedModelDir,selectedModelFile:this.state.selectedModelFile,selectedAnim:this.state.selectedAnim,onAnimSelected:this.onAnimSelected,selectedAnimDir:this.state.selectedAnimDir,selectedAnimFile:this.state.selectedAnimFile,bgColor:this.state.bgColor,onBgColorChange:this.onBgColorChange,showTextures:this.state.showTextures,showWireframe:this.state.showWireframe,showVertexNormals:this.state.showVertexNormals,useCamera:this.state.useCamera,onFeatureChange:this.onFeatureChange}),React.createElement(i,{selectedModelDir:this.state.selectedModelDir,selectedModelFile:this.state.selectedModelFile,selectedAnimDir:this.state.selectedAnimDir,selectedAnimFile:this.state.selectedAnimFile,bgColor:this.state.bgColor,showTextures:this.state.showTextures,showWireframe:this.state.showWireframe,showVertexNormals:this.state.showVertexNormals,useCamera:this.state.useCamera}))}}]),t}(),t=void 0,r=void 0,o=void 0,s=void 0,n=void 0,a=void 0,l=void 0,i=function(e){function i(){var e,t,o,n;_classCallCheck(this,i);for(var a=arguments.length,l=Array(a),c=0;c<a;c++)l[c]=arguments[c];return t=o=_possibleConstructorReturn(this,(e=i.__proto__||Object.getPrototypeOf(i)).call.apply(e,[this].concat(l))),o.state={hasError:!1},o.onWindowResize=function(){if(s&&r){var e=ReactDOM.findDOMNode(o),t=e.offsetHeight,n=e.offsetWidth;r.aspect=n/t,r.updateProjectionMatrix(),s.setSize(n,t)}},n=t,_possibleConstructorReturn(o,n)}return _inherits(i,React.Component),_createClass(i,[{key:"render",value:function(){return this.state.hasError?React.createElement("p",null,"An error occurred during rendering, see the browser console."):React.createElement("div",{className:"modelRenderContainer"})}},{key:"componentDidCatch",value:function(e,t){this.setState({hasError:!0}),console.error(e,t)}},{key:"componentDidMount",value:function(){try{window.addEventListener("resize",this.onWindowResize),t=this,this.initModel()}catch(e){console.error(e)}}},{key:"componentWillUnmount",value:function(){try{window.removeEventListener("resize",this.onWindowResize),t=null,this.clearViewer()}catch(e){console.error(e)}}},{key:"componentDidUpdate",value:function(){try{this.clearViewer(),this.initModel()}catch(e){console.error(e)}}},{key:"clearViewer",value:function(){this.disposeTHREERenderer(),this.disposeTHREEObj(o),o=null,l&&(l.stopAllAction(),l=null),a&&(a.stop(),a=null)}},{key:"disposeTHREERenderer",value:function(){if(s){s.dispose(),s.forceContextLoss();var e=ReactDOM.findDOMNode(this);s.domElement.offsetParent&&e.removeChild(s.domElement),s.context=void 0,s.domElement=void 0,s=null}}},{key:"disposeTHREEObj",value:function(e){if(e){for(var t=0;t<e.children.length;t++)this.disposeTHREEObj(e.children[t]);if(e.geometry&&(e.geometry.dispose(),e.geometry=void 0),e.material){var r=void 0;e.material instanceof THREE.MeshFaceMaterial||e.material instanceof THREE.MultiMaterial?r=e.material.materials:e.material instanceof Array&&(r=e.material),r?r.forEach(function(e,t){e.map&&e.map.dispose(),e.lightMap&&e.lightMap.dispose(),e.bumpMap&&e.bumpMap.dispose(),e.normalMap&&e.normalMap.dispose(),e.specularMap&&e.specularMap.dispose(),e.envMap&&e.envMap.dispose(),e.dispose()}):(e.material.map&&e.material.map.dispose(),e.material.lightMap&&e.material.lightMap.dispose(),e.material.bumpMap&&e.material.bumpMap.dispose(),e.material.normalMap&&e.material.normalMap.dispose(),e.material.specularMap&&e.material.specularMap.dispose(),e.material.envMap&&e.material.envMap.dispose(),e.material.dispose())}}}},{key:"initModel",value:function(){if(null!==this.props.selectedModelDir){var e=[this.props.selectedModelDir,this.props.selectedModelFile],t=e[0],i=e[1],c=ReactDOM.findDOMNode(this),u=c.offsetHeight,d=c.offsetWidth;(o=new THREE.Scene).background=new THREE.Color(this.props.bgColor),$$log("Rendering model "+t+"/"+i);var h=PP64.utils.FORM.unpack(PP64.fs.mainfs.get(t,i));$$log("form",h);var p=new PP64.utils.FormToThreeJs;p.bgColor=this.props.bgColor,p.showTextures=this.props.showTextures,p.showWireframe=this.props.showWireframe,p.showVertexNormals=this.props.showVertexNormals,p.useFormCamera=this.props.useCamera;var m=p.createModel(h);if(o.add(m),this.props.showVertexNormals){var f=new THREE.VertexNormalsHelper(m,8,65280,1);o.add(f)}if($$log("Scene",o),null!==this.props.selectedAnimDir){var C=[this.props.selectedAnimDir,this.props.selectedAnimFile],g=C[0],v=C[1],y=PP64.utils.MTNX.unpack(PP64.fs.mainfs.get(g,v));$$log("mtnx",y);var w=new PP64.utils.MtnxToThreeJs;w.form=h;var M=w.createClip(y);$$log("mtnxClip",M);(l=new THREE.AnimationMixer(o)).clipAction(M).play(),a=new THREE.Clock}(s=new THREE.WebGLRenderer({antialias:!0})).setSize(d,u),c.appendChild(s.domElement),r=p.createCamera(h,d,u),n=new THREE.OrbitControls(r,s.domElement),this.animate()}}},{key:"renderModel",value:function(){s.render(o,r)}},{key:"animate",value:function(){if(t&&s){if(n.update(),a){var e=a.getDelta();l&&l.update(e)}t.renderModel(),requestAnimationFrame(t.animate)}}}]),i}(),c=function(e){function t(){var e,r,o,s;_classCallCheck(this,t);for(var n=arguments.length,a=Array(n),l=0;l<n;l++)a[l]=arguments[l];return r=o=_possibleConstructorReturn(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(a))),o.state={},s=r,_possibleConstructorReturn(o,s)}return _inherits(t,React.Component),_createClass(t,[{key:"render",value:function(){return React.createElement("div",{className:"modelViewerToolbar"},React.createElement(u,{selectedModel:this.props.selectedModel,onModelSelected:this.props.onModelSelected}),React.createElement(d,{selectedAnim:this.props.selectedAnim,onAnimSelected:this.props.onAnimSelected}),React.createElement(h,{selectedColor:this.props.bgColor,onColorChange:this.props.onBgColorChange}),React.createElement(p,{showTextures:this.props.showTextures,showWireframe:this.props.showWireframe,showVertexNormals:this.props.showVertexNormals,useCamera:this.props.useCamera,onFeatureChange:this.props.onFeatureChange}),React.createElement("div",{className:"modelViewerToolbarSpacer"}),React.createElement(m,{selectedModelDir:this.props.selectedModelDir,selectedModelFile:this.props.selectedModelFile}))}}]),t}(),u=function(e){function t(){var e,r,o,s;_classCallCheck(this,t);for(var n=arguments.length,a=Array(n),l=0;l<n;l++)a[l]=arguments[l];return r=o=_possibleConstructorReturn(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(a))),o.state={},o.modelSelected=function(e){o.props.onModelSelected&&o.props.onModelSelected(e.target.value)},s=r,_possibleConstructorReturn(o,s)}return _inherits(t,React.Component),_createClass(t,[{key:"render",value:function(){var e=this.getModelEntries().map(function(e){return React.createElement("option",{value:e,key:e},e)});return React.createElement("div",{className:"modelSelectContainer"},"Model:",React.createElement("select",{value:this.props.selectedModel,onChange:this.modelSelected},e))}},{key:"getModelEntries",value:function(){for(var e=[],t=PP64.fs.mainfs.getDirectoryCount(),r=0;r<t;r++)for(var o=PP64.fs.mainfs.getFileCount(r),s=0;s<o;s++){var n=PP64.fs.mainfs.get(r,s);if(PP64.utils.FORM.isForm(n)){var a=r+"/"+s;try{e.push(a)}catch(e){console.error("Could not parse FORM "+r+"/"+s,e)}}}return e}}]),t}(),d=function(e){function t(){var e,r,o,s;_classCallCheck(this,t);for(var n=arguments.length,a=Array(n),l=0;l<n;l++)a[l]=arguments[l];return r=o=_possibleConstructorReturn(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(a))),o.state={},o.animSelected=function(e){o.props.onAnimSelected&&o.props.onAnimSelected(e.target.value)},s=r,_possibleConstructorReturn(o,s)}return _inherits(t,React.Component),_createClass(t,[{key:"render",value:function(){var e=this.getAnimEntries().map(function(e){return React.createElement("option",{value:e,key:e},e)});return e.unshift(React.createElement("option",{value:"",key:""})),React.createElement("div",{className:"modelSelectContainer"},"Animation:",React.createElement("select",{value:this.props.selectedAnim,onChange:this.animSelected},e))}},{key:"getAnimEntries",value:function(){for(var e=[],t=PP64.fs.mainfs.getDirectoryCount(),r=0;r<t;r++)for(var o=PP64.fs.mainfs.getFileCount(r),s=0;s<o;s++){var n=PP64.fs.mainfs.get(r,s);if(PP64.utils.MTNX.isMtnx(n)){var a=r+"/"+s;try{e.push(a)}catch(e){console.error("Could not parse MTNX "+r+"/"+s,e)}}}return e}}]),t}(),h=function(e){function t(){var e,r,o,s;_classCallCheck(this,t);for(var n=arguments.length,a=Array(n),l=0;l<n;l++)a[l]=arguments[l];return r=o=_possibleConstructorReturn(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(a))),o.state={},o.onColorChange=function(e,t){o.setState({color:e}),o.props.onColorChange(e)},s=r,_possibleConstructorReturn(o,s)}return _inherits(t,React.Component),_createClass(t,[{key:"render",value:function(){var e=PP64.controls.ToggleButton;return React.createElement("div",{className:"modelViewerColorPicker"},React.createElement(e,{id:0,key:0,allowDeselect:!1,onToggled:this.onColorChange,pressed:0===this.props.selectedColor},React.createElement("span",{className:"colorSwatch",title:"Change background to black",style:{backgroundColor:"#000000"}})),React.createElement(e,{id:16777215,key:1,allowDeselect:!1,onToggled:this.onColorChange,pressed:16777215===this.props.selectedColor},React.createElement("span",{className:"colorSwatch",title:"Change background to white",style:{backgroundColor:"#FFFFFF"}})))}}]),t}(),p=function(e){function t(){var e,r,o,s;_classCallCheck(this,t);for(var n=arguments.length,a=Array(n),l=0;l<n;l++)a[l]=arguments[l];return r=o=_possibleConstructorReturn(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(a))),o.state={},o.onShowTextureChange=function(e){var t=e.target.checked;t||o.props.showWireframe?o.props.onFeatureChange({showTextures:t}):o.props.onFeatureChange({showTextures:t,showWireframe:!0})},o.onShowWireframeChange=function(e){var t=e.target.checked;t||o.props.showTextures?o.props.onFeatureChange({showWireframe:t}):o.props.onFeatureChange({showTextures:!0,showWireframe:t})},o.onShowNormalsChange=function(e){var t=e.target.checked;o.props.onFeatureChange({showVertexNormals:t})},o.onUseCameraChange=function(e){var t=e.target.checked;o.props.onFeatureChange({useCamera:t})},s=r,_possibleConstructorReturn(o,s)}return _inherits(t,React.Component),_createClass(t,[{key:"render",value:function(){var e=void 0;return PP64.settings.get($setting.uiAdvanced)&&(e=[React.createElement("label",null,React.createElement("input",{type:"checkbox",key:"modelFeatureSelectShowVertexNormals",checked:this.props.showVertexNormals,onChange:this.onShowNormalsChange}),"Vertex Normals")]),React.createElement("div",{className:"modelFeatureSelectContainer"},React.createElement("label",null,React.createElement("input",{type:"checkbox",key:"modelFeatureSelectShowTextures",checked:this.props.showTextures,onChange:this.onShowTextureChange}),"Textures"),React.createElement("label",null,React.createElement("input",{type:"checkbox",key:"modelFeatureSelectShowWireframe",checked:this.props.showWireframe,onChange:this.onShowWireframeChange}),"Wireframe"),React.createElement("label",{title:"Use the camera defined by the model"},React.createElement("input",{type:"checkbox",key:"modelFeatureSelectUseCamera",checked:this.props.useCamera,onChange:this.onUseCameraChange}),"Camera"),e)}}]),t}(),m=function(e){function t(){var e,r,o,s;_classCallCheck(this,t);for(var n=arguments.length,a=Array(n),l=0;l<n;l++)a[l]=arguments[l];return r=o=_possibleConstructorReturn(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(a))),o.state={},o.export=function(){var e=[o.props.selectedModelDir,o.props.selectedModelFile],t=e[0],r=e[1],s=PP64.utils.FORM.unpack(PP64.fs.mainfs.get(t,r)),n=(new PP64.utils.FormToThreeJs).createModel(s);GLTFUtils.exportGLTF(GLTFUtils.glTFAssetFromTHREE(n),{jsZip:JSZip}).then(function(e){saveAs(e,"model-"+t+"-"+r+".zip")})},s=r,_possibleConstructorReturn(o,s)}return _inherits(t,React.Component),_createClass(t,[{key:"render",value:function(){var e=PP64.controls.Button;return React.createElement(e,{onClick:this.export,css:"btnModelExport"},React.createElement("img",{src:"img/model/export.png",height:"16",width:"16"}),"glTF")}}]),t}();return{ModelViewer:e}}();
...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,r){for(var a=0;a<r.length;a++){var t=r[a];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(r,a,t){return a&&e(r.prototype,a),t&&e(r,t),r}}();PP64.ns("utils"),PP64.utils.MtnxToThreeJs=function(){function e(){_classCallCheck(this,e)}return _createClass(e,[{key:"createClip",value:function(e){var r=this._createTracks(e),a=this._framesToSeconds(e.totalFrames);return new THREE.AnimationClip("MTNX",a,r)}},{key:"_createTracks",value:function(e){for(var r=[],a=0;a<e.tracks.length;a++){var t=this._createTrack(e.tracks[a]);t&&r.push(t)}return r}},{key:"_createTrack",value:function(e){var r=PP64.utils.MTNX.TrackType;switch(e.type){case r.Transform:return this._createTransformTrack(e);case r.Rotation:return this._createRotationTrack(e)}console.warn("Unsupported track type "+e.type)}},{key:"_createTransformTrack",value:function(e){var r=this._createTransformTrackName(e),a=this._createKeyframeSecsArr(e.keyframes),t=this._createTransformTrackData(e);return new THREE.VectorKeyframeTrack(r,a,t)}},{key:"_createTransformTrackName",value:function(e){return this._getObjNameFromIndex(e.objIndex)+".position["+this._getDimensionProperty(e.dimension)+"]"}},{key:"_createTransformTrackData",value:function(e){var r=[];for(var a in e.keyframes){var t=e.keyframes[a].value1;r.push(t)}return r}},{key:"_createRotationTrack",value:function(e){var r=this._createRotationTrackName(e),a=this._createKeyframeSecsArr(e.keyframes),t=this._createRotationTrackData(e);return new THREE.QuaternionKeyframeTrack(r,a,t)}},{key:"_createRotationTrackName",value:function(e){return this._getObjNameFromIndex(e.objIndex)+".quaternion"}},{key:"_createRotationTrackData",value:function(e){var r=[];for(var a in e.keyframes){var t=e.keyframes[a].value1,n=this._createQuaternion(e.dimension,t);r.push(n.x,n.y,n.z,n.w)}return r}},{key:"_createQuaternion",value:function(e,r){var a=new THREE.Quaternion,t=$$number.degreesToRadians(r),n=PP64.utils.MTNX.Dimension;switch(e){case n.X:a.setFromAxisAngle(new THREE.Vector3(1,0,0),t);break;case n.Y:a.setFromAxisAngle(new THREE.Vector3(0,1,0),t);break;case n.Z:a.setFromAxisAngle(new THREE.Vector3(0,0,1),t);break;default:console.warn("Didn't set quaternion value for "+$$hex(e))}return a}},{key:"_createKeyframeSecsArr",value:function(e){var r=[];for(var a in e)r.push(this._framesToSeconds(parseInt(a)));return r}},{key:"_getDimensionProperty",value:function(e){var r=PP64.utils.MTNX.Dimension;switch(e){case r.X:return"x";case r.Y:return"y";case r.Z:return"z"}throw"Unknown dimension "+$$hex(e)}},{key:"_getObjNameFromIndex",value:function(e){var r=this.form.OBJ1[0].parsed.objects[e];return $$hex(r.globalIndex)}},{key:"_framesToSeconds",value:function(e){return e/30}}]),e}();
