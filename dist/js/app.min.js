...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}();PP64.ns("utils"),PP64.utils.dump=function(){function t(){_classCallCheck(this,t)}return _createClass(t,null,[{key:"create",value:function(t){for(var e=new JSZip,n=e.folder("mainfs"),i=PP64.fs.mainfs.getDirectoryCount(),a=0;a<i;a++)for(var r=n.folder(a.toString()),s=PP64.fs.mainfs.getFileCount(a),o=0;o<s;o++){var f=PP64.fs.mainfs.get(a,o),l=o.toString();PP64.utils.FORM.isForm(f)?l+=".form":PP64.utils.MTNX.isMtnx(f)&&(l+=".mtnx"),r.file(l,f)}e.generateAsync({type:"blob"}).then(t)}},{key:"load",value:function(t){(new JSZip).loadAsync(t).then(function(t){t.folder("mainfs").forEach(function(t,e){var n=/(\d+)\/(\d+)/,i=t.match(n);if(i){var a=parseInt(i[1]),r=parseInt(i[2]);isNaN(a)||isNaN(r)||e.async("arraybuffer").then(function(t){$$log("Overwriting MainFS "+a+"/"+r),PP64.fs.mainfs.write(a,r,t)})}})},function(t){$$log(t),PP64.app.showMessage("Something went wrong while loading the zip. "+t)})}},{key:"images",value:function(){function t(t,e){var n=PP64.fs.mainfs.get(t,e),i=PP64.utils.img.ImgPack.fromPack(n);if(i&&i.length)return i.map(function(t){return new DataView(t.src)})}function e(t,e){var n=PP64.fs.mainfs.get(t,e),i=PP64.utils.img.ImgPack.fromPack(n);if(i&&i.length)return i}for(var n=new JSZip,i=n.folder("mainfs"),a=PP64.fs.mainfs.getDirectoryCount(),r=0;r<a;r++)!function(n){for(var a=i.folder(n.toString()),r=PP64.fs.mainfs.getFileCount(n),s=0;s<r;s++)!function(i){try{var r=PP64.fs.mainfs.get(n,i);if(PP64.utils.FORM.isForm(r)){var s=PP64.utils.FORM.unpack(r);s.BMP1.length&&s.BMP1.forEach(function(t,e){var n=PP64.utils.arrays.arrayBufferToDataURL(t.parsed.src,t.parsed.width,t.parsed.height);a.file(i+"."+e+".png",n.substr(n.indexOf(",")+1),{base64:!0})})}else{var o=e(n,i);if(o.forEach(function(t,e){var n=PP64.utils.arrays.arrayBufferToDataURL(t.src,t.width,t.height);a.file(i+"."+e+".png",n.substr(n.indexOf(",")+1),{base64:!0})}),o.length>1){var f=PP64.utils.img.tiler.fromTiles(t(n,i),o.length,1,4*o[0].width,o[0].height),l=PP64.utils.arrays.arrayBufferToDataURL(f,o[0].width*o.length,o[0].height);a.file(i+".all.png",l.substr(l.indexOf(",")+1),{base64:!0})}}}catch(t){}}(s)}(r);n.generateAsync({type:"blob"}).then(function(t){saveAs(t,"mp"+PP64.romhandler.getGameVersion()+"-images.zip")})}},{key:"formImages",value:function(){for(var t=PP64.fs.mainfs.getDirectoryCount(),e=0;e<t;e++)!function(t){for(var e=PP64.fs.mainfs.getFileCount(t),n=0;n<e;n++)!function(e){var n=PP64.fs.mainfs.get(t,e);if(!PP64.utils.FORM.isForm(n))return"continue";try{var i=PP64.utils.FORM.unpack(n);i.BMP1.length&&i.BMP1.forEach(function(n){var i=PP64.utils.arrays.arrayBufferToDataURL(n.parsed.src,n.parsed.width,n.parsed.height);console.log(t+"/"+e+":"),console.log(i)})}catch(t){}}(n)}(e)}},{key:"strings3",value:function(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",e=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=PP64.fs.strings3.getDirectoryCount("en"),i=0;i<n;i++)for(var a=PP64.fs.strings3.getStringCount("en",i),r=0;r<a;r++){var s=PP64.fs.strings3.read("en",i,r);if(!(s.indexOf(t)<0)){var o=i+"/"+r+":\n"+s;e&&(o+="\n"+PP64.utils.arrays.toHexString(PP64.fs.strings3.read("en",i,r,!0))),console.log(o)}}}},{key:"strings",value:function(){for(var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",e=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=PP64.fs.strings.getStringCount(),i=0;i<n;i++){var a=PP64.fs.strings.read(i);if(!(a.indexOf(t)<0)){var r=i+":\n"+a;e&&(r+="\n"+PP64.utils.arrays.toHexString(PP64.fs.strings.read(i,!0))),console.log(r)}}}},{key:"saveWaluigi",value:function(){if(3!==PP64.romhandler.getGameVersion())throw"Waluigi is not in game "+PP64.romhandler.getGameVersion();window.waluigiParts=[];for(var t=0;t<163;t++)window.waluigiParts.push(PP64.fs.mainfs.get(8,t));return window.waluigiParts}},{key:"writeWaluigi",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1;if(1!==PP64.romhandler.getGameVersion())throw"Waluigi cannot write to MP"+PP64.romhandler.getGameVersion();if(!window.waluigiParts)throw"Need to call saveWaluigi first!";163===window.waluigiParts.length&&window.waluigiParts.splice(158,2);for(var e=0;e<window.waluigiParts.length;e++)PP64.fs.mainfs.write(t,e,window.waluigiParts[e])}},{key:"saveDaisy",value:function(){if(3!==PP64.romhandler.getGameVersion())throw"Daisy is not in game "+PP64.romhandler.getGameVersion();return window.daisyParts=[],window.daisyParts.push(PP64.fs.mainfs.get(9,1)),window.daisyParts.push(PP64.fs.mainfs.get(9,3)),window.daisyParts}},{key:"writeDaisy",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:6;if(1!==PP64.romhandler.getGameVersion())throw"Daisy cannot write to MP"+PP64.romhandler.getGameVersion();if(!window.daisyParts)throw"Need to call saveDaisy first!";PP64.fs.mainfs.write(t,158,window.daisyParts[0]),PP64.fs.mainfs.write(t,159,window.daisyParts[1])}},{key:"searchForPatchLocations",value:function(t){if(!t)throw"Please pass a ROM offset the game tries to read at runtime";for(var e=(4294901760&t)>>>16,n=65535&t,i=0,a=PP64.romhandler.getDataView(),r=a.byteLength-10,s=2;s<r;s+=2){var o=a.getUint16(s);if(o===e||o+1===e||o-1===e){var f=0;(s>8&&a.getUint16(f=s-8)===n||s>4&&a.getUint16(f=s-4)===n||a.getUint16(f=s+2)===n||a.getUint16(f=s+3)===n||a.getUint16(f=s+4)===n||a.getUint16(f=s+5)===n||a.getUint16(f=s+6)===n||a.getUint16(f=s+7)===n||a.getUint16(f=s+8)===n||a.getUint16(f=s+9)===n||a.getUint16(f=s+10)===n||a.getUint16(f=s+12)===n||a.getUint16(f=s+16)===n||a.getUint16(f=s+20)===n)&&(console.log("Found "+$$hex(s)+", "+$$hex(f)+" ("+(f-s)+") Lower inst: "+$$hex(a.getUint16(f-2))),i++)}}console.log("Found "+i+" possible locations")}},{key:"printSceneTable",value:function(){var t=PP64.adapters.getROMAdapter(),e=t&&t.SCENE_TABLE_ROM;if(e){for(var n=PP64.romhandler.getDataView(),i=[],a=e;1142947840!==n.getUint32(a);)i.push({i:$$hex(i.length),rom_start:$$hex(n.getUint32(a)),rom_end:$$hex(n.getUint32(a+4)),code_start:$$hex(n.getUint32(a+12)),rodata_start:$$hex(n.getUint32(a+20)),bss_start:$$hex(n.getUint32(a+28)),bss_end:$$hex(n.getUint32(a+32))}),a+=36;console.table(i)}else console.log("ROM is not loaded, or scene table location is unknown")}}]),t}();
