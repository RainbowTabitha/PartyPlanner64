...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();PP64.renderer=function(){function e(e,t){var n=Math.floor((t.offsetWidth-e.bg.width)/2);n=Math.max(0,n);var r=Math.floor((t.offsetHeight-e.bg.height)/2);return r=Math.max(0,r),"translateX("+n+"px) translateY("+r+"px)"}function t(e,t,n){(!(arguments.length>3&&void 0!==arguments[3])||arguments[3])&&t.clearRect(0,0,e.width,e.height),n.links=n.links||{};for(var a in n.links)for(var o=n.spaces[a].x,s=n.spaces[a].y,i=PP64.boards.getConnections(a,n),c=void 0,l=void 0,p=!1,u=0;u<i.length;u++)c=n.spaces[i[u]].x,l=n.spaces[i[u]].y,(p=function(e,t,n){var r=e[t];return Array.isArray(r)?r.indexOf(parseInt(n))>=0:r==n}(n.links,i[u],a))&&a>i[u]||r(t,o,s,c,l,p)}function n(e,t,n){var r=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:{};r&&t.clearRect(0,0,e.width,e.height);for(var o=n.game||1,s=0;s<n.spaces.length;s++){var i=n.spaces[s];null!==i&&(i.z=i.z||0,function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{},a=t.x,o=t.y,s=t.type,i=t.subtype;switch(s){case $spaceType.OTHER:if(r.skipHiddenSpaces)break;3===n?PP64.spaces.drawOther3(e,a,o):PP64.spaces.drawOther(e,a,o);break;case $spaceType.BLUE:3===n?PP64.spaces.drawBlue3(e,a,o):PP64.spaces.drawBlue(e,a,o);break;case $spaceType.RED:3===n?PP64.spaces.drawRed3(e,a,o):PP64.spaces.drawRed(e,a,o);break;case $spaceType.MINIGAME:PP64.spaces.drawMiniGame(e,a,o);break;case $spaceType.HAPPENING:3===n?PP64.spaces.drawHappening3(e,a,o):PP64.spaces.drawHappening(e,a,o);break;case $spaceType.STAR:3===n?PP64.spaces.drawStar3(e,a,o):PP64.spaces.drawStar(e,a,o);break;case $spaceType.CHANCE:3===n?PP64.spaces.drawChance3(e,a,o):2===n?PP64.spaces.drawChance2(e,a,o):PP64.spaces.drawChance(e,a,o);break;case $spaceType.START:if(r.skipHiddenSpaces)break;3===n?PP64.spaces.drawStart3(e,a,o):PP64.spaces.drawStart(e,a,o);break;case $spaceType.SHROOM:PP64.spaces.drawShroom(e,a,o);break;case $spaceType.BOWSER:3===n?PP64.spaces.drawBowser3(e,a,o):PP64.spaces.drawBowser(e,a,o);break;case $spaceType.ITEM:3===n?PP64.spaces.drawItem3(e,a,o):PP64.spaces.drawItem2(e,a,o);break;case $spaceType.BATTLE:3===n?PP64.spaces.drawBattle3(e,a,o):PP64.spaces.drawBattle2(e,a,o);break;case $spaceType.BANK:3===n?PP64.spaces.drawBank3(e,a,o):PP64.spaces.drawBank2(e,a,o);break;case $spaceType.ARROW:PP64.spaces.drawArrow(e,a,o,n);break;case $spaceType.BLACKSTAR:PP64.spaces.drawBlackStar2(e,a,o);break;case $spaceType.GAMEGUY:PP64.spaces.drawGameGuy3(e,a,o);break;default:PP64.spaces.drawUnknown(e,a,o)}r.skipCharacters||function(e,t,n,r,a){r===$spaceSubType.TOAD&&(3===a?e.drawImage(PP64.images.get("mstarImg"),t-15,n-22):e.drawImage(PP64.images.get("toadImg"),t-9,n-22));r===$spaceSubType.BOWSER&&e.drawImage(PP64.images.get("bowserImg"),t-27,n-45);r===$spaceSubType.KOOPA&&e.drawImage(PP64.images.get("koopaImg"),t-12,n-22);r===$spaceSubType.BOO&&e.drawImage(PP64.images.get("booImg"),t-13,n-17);r===$spaceSubType.GOOMBA&&e.drawImage(PP64.images.get("goombaImg"),t-8,n-12);r===$spaceSubType.BANK&&(2===a?e.drawImage(PP64.images.get("bank2Img"),t-9,n-10):e.drawImage(PP64.images.get("bank3Img"),t-17,n-20));r===$spaceSubType.BANKCOIN&&e.drawImage(PP64.images.get("bankcoinImg"),t-10,n-9);r===$spaceSubType.ITEMSHOP&&(2===a?e.drawImage(PP64.images.get("itemShop2Img"),t-9,n-10):e.drawImage(PP64.images.get("itemShop3Img"),t-16,n-20))}(e,a,o,i,n);if(!r.skipBadges){var c=3===n?5:2,l=3===n?16:12;if(t.events&&t.events.length){var p=o+c;s===$spaceType.START&&(p-=l),e.drawImage(PP64.images.get("eventImg"),a+c,p)}if(t.star){var u=o+c;s===$spaceType.START&&(u-=l),e.drawImage(PP64.images.get("starImg"),a-c-9,u)}if(t.subtype===$spaceSubType.GATE){var d=a-c-9,h=o+c-5;e.drawImage(PP64.images.get("gateImg"),d,h)}}if($$debug){e.save();var g=PP64.boards.getSpaceIndex(t);e.fillStyle="white",e.strokeStyle="black",e.lineWidth=2,e.font="bold 6pt Courier New",e.textAlign="center";var f=g.toString();e.strokeText(f,a,o-2),e.fillText(f,a,o-2),f=$$hex(g),e.strokeText(f,a,o+8),e.fillText(f,a,o+8),e.restore()}}(t,i,o,a))}}function r(e,t,n,r,a,o){e.save(),e.beginPath(),e.strokeStyle="rgba(255, 185, 105, 0.75)",e.lineCap="round",e.lineWidth=8,e.moveTo(t,n),e.lineTo(r,a),e.stroke();var i=(t+r)/2,c=(n+a)/2;e.translate(i,c),e.rotate(-Math.atan2(t-i,n-c)+s),e.fillStyle="#A15000";var l=o?3:0;e.moveTo(-4,-2+l),e.lineTo(0,2+l),e.lineTo(4,-2+l),e.fill(),o&&(e.moveTo(-4,2-l),e.lineTo(0,-2-l),e.lineTo(4,2-l),e.fill()),e.restore()}function a(){l&&clearInterval(l),l=null,p=-1,PP64.renderer.renderBG()}function o(){var e=PP64.boards.getCurrentBoard(),t=e.animbg;i&&t&&t.length?(p>=0&&p<t.length?(i.setSource(t[p]),p++):p=-1,-1===p&&(i.setSource(e.bg.src),p++)):a()}PP64.types.isKnownSpaceType;var s=Math.PI/1,i=void 0,c=function(t){function n(){var e,t,r,a;_classCallCheck(this,n);for(var o=arguments.length,s=Array(o),i=0;i<o;i++)s[i]=arguments[i];return t=r=_possibleConstructorReturn(this,(e=n.__proto__||Object.getPrototypeOf(n)).call.apply(e,[this].concat(s))),r.state={},a=t,_possibleConstructorReturn(r,a)}return _inherits(n,React.Component),_createClass(n,[{key:"componentDidMount",value:function(){this.renderContent(),i=this}},{key:"componentWillUnmount",value:function(){i=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var t=this.props.board,n=this.getImage(),r=e(t,n.parentElement);n.style.transform=r,n._src===t.bg.src&&n.width===t.bg.width&&n.height===t.bg.height||(n.width=t.bg.width,n.height=t.bg.height,this.setSource(t.bg.src,n))}},{key:"getImage",value:function(){return ReactDOM.findDOMNode(this)}},{key:"setSource",value:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:this.getImage();t.src=e,t._src=e}},{key:"render",value:function(){return React.createElement("img",{className:"editor_bg"})}}]),n}(),l=void 0,p=-1,u=void 0,d=function(n){function r(){var e,t,n,a;_classCallCheck(this,r);for(var o=arguments.length,s=Array(o),i=0;i<o;i++)s[i]=arguments[i];return t=n=_possibleConstructorReturn(this,(e=r.__proto__||Object.getPrototypeOf(r)).call.apply(e,[this].concat(s))),n.state={},a=t,_possibleConstructorReturn(n,a)}return _inherits(r,React.Component),_createClass(r,[{key:"componentDidMount",value:function(){this.renderContent(),u=this}},{key:"componentWillUnmount",value:function(){u=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var n=ReactDOM.findDOMNode(this),r=n.parentElement,a=this.props.board,o=e(a,r);n.style.transform=o,n.width===a.bg.width&&n.height===a.bg.height||(n.width=a.bg.width,n.height=a.bg.height),t(n,n.getContext("2d"),a)}},{key:"render",value:function(){return React.createElement("canvas",{className:"editor_line_canvas"})}}]),r}(),h=void 0,g=function(t){function n(){var e,t,r,a;_classCallCheck(this,n);for(var o=arguments.length,s=Array(o),i=0;i<o;i++)s[i]=arguments[i];return t=r=_possibleConstructorReturn(this,(e=n.__proto__||Object.getPrototypeOf(n)).call.apply(e,[this].concat(s))),r.state={},a=t,_possibleConstructorReturn(r,a)}return _inherits(n,React.Component),_createClass(n,[{key:"componentDidMount",value:function(){this.renderContent(),h=this}},{key:"componentWillUnmount",value:function(){h=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var t=ReactDOM.findDOMNode(this),n=t.parentElement,r=this.props.board,a=e(r,n);t.style.transform=a,t.width===r.bg.width&&t.height===r.bg.height||(t.width=r.bg.width,t.height=r.bg.height),function(e,t,n){if(t.clearRect(0,0,e.width,e.height),n){t.save(),t.beginPath();var r=3===PP64.boards.getCurrentBoard().game?16:10;t.arc(n.x,n.y,r,0,2*Math.PI),t.shadowColor="rgba(225, 225, 225, 1)",t.shadowBlur=2,t.fillStyle="rgba(225, 225, 225, 0.5)",t.fill(),t.restore()}}(t,t.getContext("2d"),this.props.currentSpace)}},{key:"render",value:function(){return React.createElement("canvas",{className:"editor_current_space_canvas"})}}]),n}(),f=void 0,m=function(t){function r(){var e,t,n,a;_classCallCheck(this,r);for(var o=arguments.length,s=Array(o),i=0;i<o;i++)s[i]=arguments[i];return t=n=_possibleConstructorReturn(this,(e=r.__proto__||Object.getPrototypeOf(r)).call.apply(e,[this].concat(s))),n.state={},a=t,_possibleConstructorReturn(n,a)}return _inherits(r,React.Component),_createClass(r,[{key:"componentDidMount",value:function(){var e=ReactDOM.findDOMNode(this);PP64.interaction.attachToCanvas(e),this.renderContent(),f=this}},{key:"componentWillUnmount",value:function(){var e=ReactDOM.findDOMNode(this);PP64.interaction.detachFromCanvas(e),f=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var t=ReactDOM.findDOMNode(this),r=t.parentElement,a=this.props.board,o=e(a,r);t.style.transform=o,t.width===a.bg.width&&t.height===a.bg.height||(t.width=a.bg.width,t.height=a.bg.height),n(t,t.getContext("2d"),a)}},{key:"render",value:function(){return React.createElement("canvas",{className:"editor_space_canvas",tabIndex:"-1",onDragOver:this.preventDefault,onDrop:this.onDrop})}}]),r}(),P=void 0,b=function(t){function n(){var e,t,r,a;_classCallCheck(this,n);for(var o=arguments.length,s=Array(o),i=0;i<o;i++)s[i]=arguments[i];return t=r=_possibleConstructorReturn(this,(e=n.__proto__||Object.getPrototypeOf(n)).call.apply(e,[this].concat(s))),r.state={rightClickSpace:null},a=t,_possibleConstructorReturn(r,a)}return _inherits(n,React.Component),_createClass(n,[{key:"componentDidMount",value:function(){this.renderContent(),P=this}},{key:"componentWillUnmount",value:function(){P=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var t=ReactDOM.findDOMNode(this),n=t.parentElement,r=e(this.props.board,n);t.style.transform=r}},{key:"setRightClickMenu",value:function(e){this.setState({rightClickSpace:e})}},{key:"rightClickOpen",value:function(){return!!this.state.rightClickSpace}},{key:"render",value:function(){var e=void 0;return this.rightClickOpen()&&(e=React.createElement(PP64.rightclick.RightClickMenu,{space:this.state.rightClickSpace})),React.createElement("div",{className:"editor_menu_overlay"},e)}}]),n}();return{render:function(){i&&i.renderContent(),u&&u.renderContent(),h&&h.renderContent(),f&&f.renderContent()},renderBG:function(){i&&i.renderContent()},renderConnections:function(){u&&u.renderContent()},renderCurrentSpace:function(){h&&h.renderContent()},renderSpaces:function(){f&&f.renderContent()},updateRightClickMenu:function(e){P&&P.setRightClickMenu(e)},rightClickOpen:function(){return!!P&&P.rightClickOpen()},drawConnection:function(e,t,n,a){if(u){r(ReactDOM.findDOMNode(u).getContext("2d"),e,t,n,a)}},drawAssociation:function(e,t,n,r,a){e.save(),e.beginPath(),e.strokeStyle="rgba(211, 211, 211, 0.75)",e.setLineDash([1,6]),e.lineCap="round",e.lineWidth=4,e.moveTo(t,n),e.lineTo(r,a),e.stroke(),e.restore()},playAnimation:function(){l||(l=setInterval(o,800))},stopAnimation:a,animationPlaying:function(){return!!l},external:{getBGImage:function(){return i.getImage()},setBGImage:function(e){i.setSource(e)},renderConnections:t,renderSpaces:n},Editor:function(e){function t(){var e,n,r,a;_classCallCheck(this,t);for(var o=arguments.length,s=Array(o),i=0;i<o;i++)s[i]=arguments[i];return n=r=_possibleConstructorReturn(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(s))),r.state={},a=n,_possibleConstructorReturn(r,a)}return _inherits(t,React.Component),_createClass(t,[{key:"componentDidMount",value:function(){window.addEventListener("resize",PP64.renderer.render,!1)}},{key:"componentWillUnmount",value:function(){window.removeEventListener("resize",PP64.renderer.render)}},{key:"componentDidUpdate",value:function(){}},{key:"render",value:function(){return React.createElement("div",{className:"editor"},React.createElement(c,{board:this.props.board}),React.createElement(d,{board:this.props.board}),React.createElement(g,{board:this.props.board,currentSpace:this.props.currentSpace}),React.createElement(m,{board:this.props.board}),React.createElement(b,{board:this.props.board}))}}]),t}()}}();
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,r,a){return r&&e(t.prototype,r),a&&e(t,a),t}}();PP64.ns("utils"),PP64.utils.FORM=function(){function e(){_classCallCheck(this,e)}return _createClass(e,null,[{key:"unpack",value:function(e){if(e instanceof DataView||(e=new DataView(e)),!PP64.utils.FORM.isForm(e))return null;var t=Object.create(null);t.entries=[];for(var r=8;r<e.byteLength-2;){var a=e.getUint32(r);"HBIN"===(a=PP64.utils.string.fromU32(a))&&(r+=4,a+=PP64.utils.string.fromU32(e.getUint32(r))),t.entries.push(a),r+=4;var n=e.getUint32(r);r+=4;var i={raw:e.buffer.slice(r,r+n)},s=PP64.utils.FORM.parseType(a,i.raw);s&&(i.parsed=s),t[a]=t[a]||[],t[a].push(i),r+=n+n%2}if(t.BMP1)for(var o=0;o<t.BMP1.length;o++){var l=t.BMP1[o];l.parsed=PP64.utils.FORM.parseBMP(l.raw,t.PAL1)}return t}},{key:"pack",value:function(e){var t=new ArrayBuffer(PP64.utils.FORM.getByteLength(e)),r=new DataView(t);r.setUint32(0,1179603533),r.setUint32(4,t.byteLength-8);for(var a={},n=8,i=0;i<e.entries.length;i++){var s=e.entries[i],o=a[s]||0;a[s]=o+1;for(var l=PP64.utils.string.toCharCodes(s),g=0;g<l.length;g++)r.setUint8(n,l[g]),n++;var u=e[s][o],c=u.raw.byteLength;r.setUint32(n,c),n+=4,PP64.utils.arrays.copyRange(r,u.raw,n,0,c),n+=c+c%2}return t}},{key:"isForm",value:function(e){return!!e&&(e instanceof DataView||(e=new DataView(e)),1179603533===e.getUint32(0))}},{key:"getByteLength",value:function(e){var t=0;for(var r in e)if("entries"!==r)for(var a=0;a<e[r].length;a++){var n=e[r][a].raw.byteLength;t+=n+n%2+r.length+4}return t+8}},{key:"parseType",value:function(e,t){switch(e){case"OBJ1":return PP64.utils.FORM.parseOBJ1(t);case"COL1":return PP64.utils.FORM.parseCOL1(t);case"MAT1":return PP64.utils.FORM.parseMAT1(t);case"ATR1":return PP64.utils.FORM.parseATR1(t);case"VTX1":return PP64.utils.FORM.parseVTX1(t);case"FAC1":return PP64.utils.FORM.parseFAC1(t);case"PAL1":return PP64.utils.FORM.parsePAL1(t);case"SKL1":return PP64.utils.FORM.parseSKL1(t);case"STRG":return PP64.utils.FORM.parseSTRG(t)}return null}},{key:"parseOBJ1",value:function(e){for(var t=new DataView(e),r={objects:[],mystery1:t.getUint16(2)},a=t.getUint16(0),n=4,i=0;i<a;i++){var s=t.getUint16(n),o=t.getUint8(n+2),l=t.getUint16(n+3);n+=5;var g=void 0;switch(o){case 61:g={children:[]};for(var u=t.getUint16(n),c=0;c<u;c++)g.children.push(t.getUint16(n+2+2*c));Object.assign(g,PP64.utils.FORM._parseOBJ1Transforms(t,n+2+2*u));break;case 58:g={mystery1:t.getUint8(n),faceIndex:t.getUint16(n+1),faceCount:t.getUint16(n+3)},Object.assign(g,PP64.utils.FORM._parseOBJ1Transforms(t,n+5));break;case 16:g={skeletonGlobalIndex:t.getUint16(n)},Object.assign(g,PP64.utils.FORM._parseOBJ1Transforms(t,n+2));break;case 59:g={},console.warn("Object type 0x3B");break;case 62:g={},console.warn("Object type 0x3E");break;case 97:g={},Object.assign(g,PP64.utils.FORM._parseOBJ1Transforms(t,n));break;case 93:g={},console.warn("Object type 0x5D");break;default:console.warn("Unrecognized object type "+$$hex(o)),g={}}g.objType=o,g.globalIndex=l,r.objects.push(g),n+=s-3}return r}},{key:"_parseOBJ1Transforms",value:function(e,t){return{posX:e.getFloat32(t),posY:e.getFloat32(t+4),posZ:e.getFloat32(t+8),rotX:e.getFloat32(t+12),rotY:e.getFloat32(t+16),rotZ:e.getFloat32(t+20),scaleX:e.getFloat32(t+24),scaleY:e.getFloat32(t+28),scaleZ:e.getFloat32(t+32)}}},{key:"parseCOL1",value:function(e){for(var t=new DataView(e),r=[],a=t.getUint16(0),n=2,i=0;i<a;i++)r.push(t.getUint32(n)),n+=4;return r}},{key:"parseMAT1",value:function(e){for(var t=new DataView(e),r={materials:[]},a=t.getUint16(0),n=2,i=0;i<a;i++){var s={mystery1:t.getUint16(n),colorIndex:t.getUint16(n+2),mystery3:t.getUint16(n+4),mystery4:t.getFloat32(n+6),mystery5:t.getUint16(n+10)};r.materials.push(s),n+=12}return r}},{key:"parseATR1",value:function(e){for(var t=new DataView(e),r={atrs:[]},a=t.getUint16(0),n=2,i=0;i<a;i++){var s={size:t.getUint16(n),xBehavior:t.getUint8(n+5),yBehavior:t.getUint8(n+6),bmpGlobalIndex:t.getUint16(n+10)};r.atrs.push(s),n+=s.size+2}return r}},{key:"parseVTX1",value:function(e){for(var t=new DataView(e),r={vertices:[],scale:t.getFloat32(4)},a=t.getUint16(0),n=8,i=0;i<a;i++){var s={x:t.getInt16(n),y:t.getInt16(n+2),z:t.getInt16(n+4),normalX:t.getInt8(n+6),normalY:t.getInt8(n+7),normalZ:t.getInt8(n+8)};r.vertices.push(s),n+=9}return r}},{key:"parseFAC1",value:function(e){for(var t=new DataView(e),r={faces:[]},a=t.getUint16(0),n=8,i=0;i<a;i++){var s=t.getUint8(n);if(53!==s&&22!==s&&48!==s)throw new Error("Unrecognized faceType in FAC1: "+$$hex(s));var o={vtxEntries:[]};if(r.faces.push(o),n+=1,48===s)console.warn("Unsupported face type 0x30"),n+=6;else for(var l=53===s?4:3,g=0;g<l;g++)o.vtxEntries[g]={vertexIndex:t.getUint16(n),materialIndex:t.getInt16(n+2),u:t.getFloat32(n+4),v:t.getFloat32(n+8)},n+=12;o.materialIndex=t.getInt16(n),o.atrIndex=t.getInt16(n+2),o.mystery3=t.getUint8(n+4),54!==o.mystery3&&console.warn("Unsupported FAC1 mystery3 ",$$hex(o.mystery3)),n+=5}return r}},{key:"parsePAL1",value:function(e){var t=new DataView(e),r={colors:[],bpp:0,globalIndex:t.getUint16(0)},a=t.getUint16(2);r.bpp=8*Math.floor((e.byteLength-4)/a);for(var n=4,i=0;i<a;i++){if(32===r.bpp)r.colors.push(t.getUint32(n));else if(16===r.bpp)r.colors.push(t.getUint16(n));else{if(8!==r.bpp)throw"FORM.parseType(PAL1): bpp: "+r.bpp;r.colors.push(t.getUint8(n))}n+=r.bpp/8}return r}},{key:"parseSKL1",value:function(e){for(var t=new DataView(e),r=t.getUint8(2),a={globalIndex:t.getUint16(0),mystery2:t.getUint8(3),skls:[]},n=4,i=0;i<r;i++){var s={objGlobalIndex:t.getUint16(n)};Object.assign(s,PP64.utils.FORM._parseOBJ1Transforms(t,n+2)),a.skls.push(s),n+=56}return a}},{key:"parseSTRG",value:function(e){for(var t=new DataView(e),r=[],a=t.getUint16(0),n=2+a,i=0;i<a;i++){for(var s="",o=t.getUint8(2+i),l=0;l<o;l++)s+=String.fromCharCode(t.getUint8(n+l));n+=o,r.push(s)}return r}},{key:"parseBMP",value:function(e,t){var r=new DataView(e),a=r.getUint16(2),n=r.getUint16(5),i=r.getUint16(7);if(296===a||552===a){if(!t)throw"Palette needed for BMP format "+$$hex(a);for(var s=r.getUint16(9),o=r.getUint16(15),l=void 0,g=0;g<t.length;g++)if(t[g].parsed.globalIndex===s){l=t[g].parsed;break}if(!l)throw"Could not locate palette at global index "+s;var u=8/(n*i/o),c=l.bpp,f=new DataView(e,17,o);return{globalIndex:r.getUint16(0),origFormat:a,paletteGlobalIndex:s,width:n,height:i,src:PP64.utils.img.BMP.toRGBA(f,l.colors,u,c)}}if(295===a){var p=r.getUint16(11);return{globalIndex:r.getUint16(0),origFormat:a,width:n,height:i,src:e.slice(13,13+p)}}if(294===a){for(var v=r.getUint16(11),h=new ArrayBuffer(n*i*4),w=new DataView(h),U=0;U<v/3;U++){var y=r.getUint8(13+U)<<24|r.getUint8(13+U+1)<<16|r.getUint8(13+U+2)<<8|255,P=4*U;w.setUint32(P,y)}return{globalIndex:r.getUint16(0),origFormat:a,width:n,height:i,src:h}}if(293===a){for(var b=r.getUint16(11),d=new ArrayBuffer(4*b),F=new DataView(d),O=0;O<b;O++){var x=r.getUint8(13+O),m=240&x|(240&x)>>>4,I=m<<24|m<<16|m<<8|(15&x|(15&x)<<4),B=4*O;F.setUint32(B,I)}return{globalIndex:r.getUint16(0),origFormat:a,width:n,height:i,src:d}}if(292===a){for(var k=r.getUint16(11),M=new ArrayBuffer(8*k),R=new DataView(M),A=0,T=0;T<k;T++){var V=r.getUint8(13+T),C=(240&V)>>>4;C|=240&V,R.setUint32(A,C<<24|C<<16|C<<8|255),A+=4;var D=15&V;D|=D<<4,R.setUint32(A,D<<24|D<<16|D<<8|255),A+=4}return{globalIndex:r.getUint16(0),origFormat:a,width:n,height:i,src:M}}return console.warn("Could not parse BMP format "+$$hex(a)),{globalIndex:r.getUint16(0),origFormat:a,width:n,height:i,src:new ArrayBuffer(n*i*4)}}},{key:"replaceBMP",value:function(e,t,r,a){PP64.utils.arrays.copyRange(e.BMP1[t].raw,r,17,0,r.byteLength),e.PAL1[t].parsed=a;var n=new DataView(e.PAL1[t].raw).getUint16(0),i=e.PAL1[t].raw=new ArrayBuffer(4+4*a.colors.length),s=new DataView(i);s.setUint16(0,n),s.setUint16(2,a.colors.length);for(var o=4,l=0;l<a.colors.length;l++)s.setUint32(o,a.colors[l]),o+=4}},{key:"getByGlobalIndex",value:function(e,t,r){if(!e[t])return null;for(var a=[],n=0;n<e[t].length;n++){var i=e[t][n].parsed;if(!i)throw"No parsed value for "+t;if(i.hasOwnProperty("globalIndex"))i.globalIndex===r&&a.push(i);else{var s=i;switch(t){case"OBJ1":s=i.objects}for(var o=0;o<s.length;o++){var l=s[o];if(!l.hasOwnProperty("globalIndex"))throw new Error("globalIndex is not a property of the searched "+t+" array in getByGlobalIndex");l.globalIndex===r&&a.push(l)}}}return a.length?1===a.length?a[0]:a:null}}]),e}();
