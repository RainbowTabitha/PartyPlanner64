...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};PP64.boards=function(){function e(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1,n={name:"Untitled",description:"Use your Star Power to finish\nthis board.",difficulty:3,spaces:[],links:{},game:e};switch(e){case 1:n.bg={width:960,height:720,src:!0},n.otherbg={boardselect:!0,boardlogo:!0,largescene:!0,conversation:!0,splashscreen:!0},n.audioIndex=24;break;case 2:n.bg={width:1152,height:864,src:!0},n.animbg=[],n.otherbg={boardselect:!0,boardselecticon:!0,boardlogo:!0,largescene:!0};break;case 3:n.bg={width:1152,height:864,src:!0},n.otherbg={boardselect:!0,boardlogo:!0,boardlogotext:!0,largescene:!0}}return n.spaces.push({x:n.bg.width-200,y:n.bg.height-200,type:$spaceType.START}),d(n),n}function n(n){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return n||(n=e(r.game||1)),r.rom&&(n._rom=!0),p.push(n),PP64.app.boardsChanged(),p.length-1}function r(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],n=p[g];return e&&(n=i(n)),n}function t(e){g=e,PP64.app.currentBoardChanged()}function o(e){return!!e._rom}function a(e,n){var t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:r();return Array.isArray(t.links[e])?!!isNaN(n)||t.links[e].indexOf(n)>=0:!isNaN(t.links[e])&&(!!isNaN(n)||t.links[e]!==n)}function s(e,n){if(n.links){delete n.links[e];for(var r in n.links){var t=n.links[r];if(Array.isArray(t)){var o=t.indexOf(e);o!==-1&&t.splice(o,1),1===t.length?n.links[r]=t[0]:t.length||delete n.links[r]}else t===e&&delete n.links[r]}}}function i(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if("object"!==("undefined"==typeof e?"undefined":_typeof(e)))return e;e=JSON.parse(JSON.stringify(e));for(var n in e)e.hasOwnProperty(n)&&("_"===n.charAt(0)&&delete e[n],"object"===_typeof(e[n])&&null!==e[n]&&(e[n]=i(e[n])));return e}function c(e,n,r){e.events=e.events||[],n&&(r?e.events.unshift(n):e.events.push(n))}function l(e,n){if(e&&n&&e.events){var r=e.events.indexOf(n);return r!==-1?void e.events.splice(r,1):void 0}}function d(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"default",r="img/themes/";switch(e.otherbg.boardselect&&(e.otherbg.boardselect=r+n+"/boardselect.png"),e.otherbg.boardselecticon&&(e.otherbg.boardselecticon=r+n+"/boardselecticon.png"),e.otherbg.boardlogo&&(e.otherbg.boardlogo=r+n+"/boardlogo.png"),e.otherbg.boardlogotext&&(e.otherbg.boardlogotext=r+n+"/boardlogotext.png"),e.otherbg.largescene&&(e.otherbg.largescene=r+n+"/largescene.png"),e.otherbg.conversation&&(e.otherbg.conversation=r+n+"/conversation.png"),e.otherbg.splashscreen&&(e.otherbg.splashscreen=r+n+"/splashscreen.png"),e.game){case 1:e.bg.src=r+n+"/bg.png";break;case 2:case 3:e.bg.src=r+n+"/bg2.png"}}var g=0,p=void 0,u=window.localStorage&&localStorage.getItem("boards");return u&&(p=JSON.parse(u)),p&&p.length||(p=[e(1)]),window.addEventListener("beforeunload",function(){if(window.localStorage){var e=p.filter(function(e){return!o(e)});try{localStorage.setItem("boards",JSON.stringify(e))}catch(e){}}}),{getCurrentBoard:r,getCurrentBoardIndex:function(){return g},setCurrentBoard:t,currentBoardIsROM:function(){return!!r()._rom},boardIsROM:o,getBoardCount:function(){return p.length},getBoards:function(){return p},getROMBoards:function(){return p.filter(function(e){return o(e)})},setBG:function(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:r();n.bg.src=e},addAnimBG:function(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:r();n.animbg=n.animbg||[],n.animbg.push(e)},removeAnimBG:function(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:r();!n.animbg||n.animbg.length<=e||e<0||n.animbg.splice(e,1)},addBoard:n,deleteBoard:function(e){isNaN(e)||e<0||e>=p.length||(1===p.length&&n(),p.splice(e,1),g>e?t(g-1):1===p.length?t(0):g===e&&g===p.length&&t(g-1),PP64.app.boardsChanged(),PP64.app.currentBoardChanged())},copyCurrentBoard:function(){var e=p[g],n=JSON.parse(JSON.stringify(e));delete n._rom,n.name="Copy of "+n.name,p.splice(g+1,0,n),PP64.app.boardsChanged()},addSpace:function(e,n,t,o){var a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:r(),s={x:e,y:n,z:0,type:t};void 0!==o&&(s.subtype=o);var i=PP64.adapters.getAdapter(a.game||1);i&&i.hydrateSpace(s);for(var c=0;c<a.spaces.length;c++)if(null===a.spaces)return a.spaces[c]=s,c;return a.spaces.push(s),a.spaces.length-1},removeSpace:function(e){function n(n){return parseInt(n)>parseInt(e)?n-1:n}var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:r();if(!(e<0||e>=t.spaces.length)){s(e,t);var o=t.spaces.length;t.spaces.splice(e,1);for(var a=void 0,i=void 0,c=0;c<o;c++)t.links.hasOwnProperty(c)&&(a=n(c),i=t.links[c],a!==c&&delete t.links[c],Array.isArray(i)?t.links[a]=i.map(n):t.links[a]=n(i))}},getSpaceIndex:function(e){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:r();return n.spaces.indexOf(e)},getStartSpace:function(e){for(var n=e.spaces,r=0;r<n.length;r++)if(n[r]&&n[r].type===PP64.types.Space.START)return r;return null},getSpacesOfSubType:function(e){for(var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:r(),t=n.spaces,o=[],a=0;a<t.length;a++)t[a]&&t[a].subtype===e&&o.push(a);return o},hasConnection:a,addConnection:function(e,n){var t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:r();e===n||a(e,n,t)||(t.links=t.links||{},Array.isArray(t.links[e])?t.links[e].push(n):isNaN(t.links[e])?n>=0&&(t.links[e]=n):t.links[e]=[t.links[e],n])},addAssociation:function(e,n){var t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:r();t.associations=t.associations||{};var o=isNaN(t.spaces[e].subtype),a=isNaN(t.spaces[n].subtype)},addEventByIndex:function(e,n,r,t){var o=e.spaces[n];c(o,r,t)},addEventToSpace:c,removeEventFromSpace:l,loadBoardsFromROM:function(){var e=PP64.adapters.getROMAdapter();if(e){for(var n=e.loadBoards(),r=0;r<n.length;r++)n[r]._rom=!0,p.push(n[r]);PP64.app.boardsChanged()}},clearBoardsFromROM:function(){for(var e=p.length-1;e>=0;e--)p[e]._rom&&p.splice(e,1);p.length||n()}}}();
...
"use strict";PP64.ns("adapters"),PP64.adapters.boarddef=function(){function t(t,r){var i=e(t);r.spaces=n(t,i);var s=a(t,i);return r.links=s.links,r._chains=s.chains,$$log("Parsing board def, "+$$hex(i.spaceCount)+" ("+i.spaceCount+") spaces"),r}function e(t){var e=new DataView(t),n=PP64.romhandler.getGameVersion();switch(n){case 1:return{spaceCount:e.getUint16(0),chainCount:e.getUint16(4),spaceStartOffset:e.getUint16(6),linkStartOffset:e.getUint16(10)};case 2:case 3:return{spaceCount:e.getUint16(0),chainCount:e.getUint16(2),spaceStartOffset:e.getUint16(4),linkStartOffset:e.getUint16(6)}}}function n(t,e){for(var n=new DataView(t,e.spaceStartOffset),a=[],r=0,i=0;i<e.spaceCount;i++)a.push({type:n.getUint8(r+3),x:n.getFloat32(r+4),y:n.getFloat32(r+12),z:n.getFloat32(r+8)}),r+=16;return a}function a(t,e){for(var n=new Array(e.chainCount),a={},r=new DataView(t,e.linkStartOffset),i=0;i<e.chainCount;i++){var s=r.getUint16(2*i),o=new DataView(t,e.linkStartOffset+s),c=o.getUint16(0);if(n[i]=[],1===c)n[i].push(o.getUint16(2));else for(var u=1;u<c;u++){var f=o.getUint16(2*u),h=o.getUint16(2*(u+1));a.hasOwnProperty(f)?(Array.isArray(a[f])||(a[f]=[a[f]]),a[f].indexOf(h)===-1&&a[f].push(h)):a[f]=h,n[i].push(f),u+1===c&&n[i].push(h)}}return{links:a,chains:n}}function r(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:f(t),n=new ArrayBuffer(i(t,e));return o(n,t,e),c(n,t.spaces),u(n,e),n}function i(t,e){var n=void 0,a=void 0,r=void 0;return n=s(),a=16*t.spaces.length,r=2*e.length,e.forEach(function(t){r+=2*(t.length+1)}),n+a+r}function s(){var t=void 0,e=PP64.romhandler.getGameVersion();switch(e){case 1:t=12;break;case 2:case 3:t=8;break;default:throw"_boardDefHeaderSize: unknown game version "+e}return t}function o(t,e,n){var a=new DataView(t),r=PP64.romhandler.getGameVersion(),i=s()+16*e.spaces.length;switch(r){case 1:a.setUint16(0,e.spaces.length),a.setUint16(4,n.length),a.setUint16(6,12),a.setUint16(8,i),a.setUint16(10,i);break;case 2:case 3:a.setUint16(0,e.spaces.length),a.setUint16(2,n.length),a.setUint16(4,8),a.setUint16(6,i)}}function c(t,e){var n=new DataView(t),a=s();e.forEach(function(t){n.setUint32(a,t.type),n.setFloat32(a+4,t.x),n.setFloat32(a+8,t.z),n.setFloat32(a+12,t.y),a+=16})}function u(t,n){var a=new DataView(t),r=void 0,i=void 0;r=i=e(t).linkStartOffset;for(var s=2*n.length,o=0;o<n.length;o++){a.setUint16(i,s),a.setUint16(r+s,n[o].length),s+=2;for(var c=0;c<n[o].length;c++)a.setUint16(r+s,n[o][c]),s+=2;i+=2}}function f(t){function e(t){for(var s=[],o=t,c=void 0;!a[o]._seen;){if(a[o]._seen=!0,s.push(o),c=r[o],Array.isArray(c))return i.push(s),void c.forEach(function(t){e(t)});if("number"!=typeof c)throw"_determineChains.parseChain hit a dead end at "+o;if(n(c,o))return i.push(s),void e(c);o=c}s.length&&i.push(s)}function n(t,e){return void 0===e?!!s[t].length:!!s[t].length&&(s[t].indexOf(Number(e))===-1||s[t].length>1)}t=PP64.utils.obj.copy(t);for(var a=t.spaces,r=t.links,i=[],s={},o=0;o<a.length;o++)a[o]&&(s[o]=[]);var c=function(t){var e=r[t];Array.isArray(e)?e.forEach(function(e){s[e].push(Number(t))}):isNaN(e)||s[e].push(Number(t))};for(var u in r)c(u);e(PP64.boards.getStartSpace(t));for(var f=0;f<a.length;f++)a[f]&&(a[f]._seen||!n(f)&&PP64.boards.hasConnection(f,null,t)&&e(f));return $$log("chains: ",i),i}function h(t,e){for(var n=t.spaces,a=t.links,r=0;r<e.length;r++){var i=e[r];if(1===i.length){var s=i[0],o=n[s],c=a[s],u=void 0,f=void 0;if(Array.isArray(c)&&c.length>1)if(2===c.length){var h=n[c[0]],l=n[c[1]],g=$$number.midpoint(h.x,h.y,l.x,l.y),p=$$number.distance(o.x,o.y,g.x,g.y),d=.01/p;u=(1-d)*o.x+d*g.x,f=(1-d)*o.y+d*g.y,$$log("Padding branch x: "+o.x+", y: "+o.y+", padX: "+u+", padY: "+f)}else u=o.x,f=o.y;else{var v=n[c],y=$$number.midpoint(o.x,o.y,v.x,v.y);u=y.x,f=y.y}var U=PP64.boards.addSpace(u,f,$spaceType.OTHER,void 0,t);i.push(U);n[U];a[s]=U,a[U]=c}}}function l(t,e){}return{parse:t,create:r,determineChains:f,padChains:h,trimChains:l}}();
