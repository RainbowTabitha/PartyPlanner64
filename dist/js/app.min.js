...
"use strict";var _slicedToArray=function(){function e(e,t){var r=[],a=!0,n=!1,s=void 0;try{for(var i,o=e[Symbol.iterator]();!(a=(i=o.next()).done)&&(r.push(i.value),!t||r.length!==t);a=!0);}catch(e){n=!0,s=e}finally{try{!a&&o.return&&o.return()}finally{if(n)throw s}}return r}return function(t,r){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,r);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();PP64.ns("adapters.events"),PP64.adapters.events.MP3=function(){var e=PP64.utils.arrays.hashEqual,t=PP64.adapters.events.EventCache,r=PP64.adapters.events.getEvent("CHAINMERGE");r._parse3=function(a,n){var s={START:"16092DD153432852C141C78807ECCBF0",END:"0855E7309F121915D7A762AB85A7FDB6"},i=[201569894,201597703],o=void 0,f=void 0;if(e([a.buffer,n.offset,8],s.START)&&i.indexOf(a.getUint32(n.offset+16))>=0&&e([a.buffer,n.offset+24,8],s.END)){if(o=a.getUint16(n.offset+14),o=o>1e3?0:o,f=0===a.getUint16(n.offset+20)?n.chains[o][0]:n.chains[o][a.getUint16(n.offset+22)],!isNaN(f)){if(n.board.links.hasOwnProperty(n.curSpace))return!1;PP64.boards.addConnection(n.curSpace,f,n.board)}var d=t.get(r.id)||{};if(!d[n.game]){d[n.game]={asm:a.buffer.slice(n.offset,n.offset+36)};var u=new DataView(d[n.game].asm);u.setUint32(8,0),u.setUint32(12,0),u.setUint32(20,0),t.set(r.id,d)}return!0}return!1};var a=PP64.adapters.events.getEvent("CHAINSPLIT");a._parse3=function(r,n){var s={METHOD_START:"16092DD153432852C141C78807ECCBF0",METHOD_END:"6FF6DF70CDC85862F8F129303009A544"};if(e([r.buffer,n.offset,8],s.METHOD_START)&&e([r.buffer,n.offset+36,20],s.METHOD_END)){var i=r.getUint16(n.offset+10)<<16,o=r.getUint16(n.offset+14),f=2147483647&(i|o);32768&f&&(f-=65536);for(var d=n.offset-(n.addr-f),u=r.getUint16(d);65535!==u;)PP64.boards.addConnection(n.curSpace,u,n.board),d+=2,u=r.getUint16(d);var c=t.get(a.id);if(c||(c={}),c[n.game]||(c[n.game]={}),!c[n.game].asm){c[n.game].asm=r.buffer.slice(n.offset,n.offset+56);var P=new DataView(c[n.game].asm);P.setUint32(8,0),P.setUint32(12,0),P.setUint32(16,0),P.setUint32(20,0),P.setUint32(24,0),P.setUint32(32,0)}return t.set(a.id,c),!0}return!1},a._write3=function(e,r,n,s){var i=t.get(a.id);if(!i||!i[n.game]||!i[n.game].asm)throw"Cannot write "+a.id+", missing cache entry values.";var o=i[n.game].asm;PP64.utils.arrays.copyRange(e,o,0,0,o.byteLength);var f=$MIPS.getRegSetUpperAndLower(n.argsAddr),d=_slicedToArray(f,2),u=d[0],c=d[1];e.setUint32(8,$MIPS.makeInst("LUI",$MIPS.REG.A0,u)),e.setUint32(12,$MIPS.makeInst("ADDIU",$MIPS.REG.A0,$MIPS.REG.A0,c));var P=$MIPS.getRegSetUpperAndLower(n.argsAddr+20),v=_slicedToArray(P,2);return u=v[0],c=v[1],e.setUint32(16,$MIPS.makeInst("LUI",$MIPS.REG.A1,u)),e.setUint32(20,$MIPS.makeInst("ADDIU",$MIPS.REG.A1,$MIPS.REG.A1,c)),e.setUint32(24,$MIPS.makeInst("LUI",$MIPS.REG.A2,32768)),e.setUint32(32,$MIPS.makeInst("ADDIU",$MIPS.REG.A2,$MIPS.REG.A2,160)),r._reverse&&(e.setUint32(36,0),e.setUint32(40,0)),[n.offset,o.byteLength]};var n=PP64.adapters.events.createEvent("REVERSECHAINSPLIT","");n.fakeEvent=!0,n.activationType=$activationType.WALKOVER,n.mystery=1,n.supportedGameVersions=[3],n.supportedGames=[$gameType.MP3_USA],n.parse=function(r,a){var s={REVERSE_FILTER:"0909C95D982B8A9B1F096AC54FFFB816"};if(!e([r.buffer,a.offset,48],s.REVERSE_FILTER))return!1;var i=(r.getUint32(a.offset+48),t.get(n.id)||{});if(!i[a.game]){i[a.game]={asm:r.buffer.slice(a.offset,a.offset+$MIPS.getFunctionLength(r,a.offset))};new DataView(i[a.game].asm);t.set(n.id,i)}return!0},n.write=function(e,r,s,i){var o=t.get(n.id);if(!o||!o[s.game]||!o[s.game].asm)throw"Cannot write "+n.id+", missing cache entry values.";r._reverse=!0;var f=a._write3(e,r,s,i),d=_slicedToArray(f,2),u=(d[0],d[1]),c=o[s.game].asm;PP64.utils.arrays.copyRange(e,c,u,0,c.byteLength);var P=2147483647&s.addr;return e.setUint32(u+48,$MIPS.makeInst("JAL",P)),[s.offset+u,u+c.byteLength]};var s=PP64.adapters.events.getEvent("STAR");s._parse3=function(t,r){var a={CHILLY:"E9B6C28983AAE724AC187EA8E0CBC79D"};return!!e([t.buffer,r.offset,956],a.CHILLY)},s._write3=function(e,t,r,a){return[3276836,0]};var i=PP64.adapters.events.getEvent("BOO");i._parse3=function(e,t){var r=void 0,a=!1;if(0===t.boardIndex){if(3291628!==t.offset)return!1;if(201568050!==e.getUint32(t.offset+76))return!1;r=$MIPS.getFunctionLength(e,t.offset),a=4564===r}return!!a},i._write3=function(e,t,r,a){if(0===r.boardIndex){var n=PP64.romhandler.getDataView();n.setUint16(3291818,r.curSpaceIndex);for(var s=PP64.boards.getSpacesOfSubType($spaceSubType.BOO,r.board),i=r.curSpace,o=Number.MAX_VALUE,f=r.board._deadSpace,d=0;d<s.length;d++){var u=s[d],c=r.board.spaces[u],P=PP64.utils.number.distance(i.x,i.y,c.x,c.y);P<o&&(o=P,f=u)}return n.setUint16(3291946,f),n.setUint16(3291958,f),[3291628,0]}throw"Can't write Boo to board index "+r.boardIndex};var o=PP64.adapters.events.getEvent("BANK");o._parse3=function(t,r){var a={CHILLY:"FCA0025616E8B2BE4CD60F47EE60DC30"};return!!e([t.buffer,r.offset,180],a.CHILLY)},o._write3=function(e,t,r,a){var n=a.curBank=a.curBank||1;a.curBank++;for(var s=PP64.boards.getSpacesOfSubType($spaceSubType.BANK,r.board),i=r.curSpace,o=Number.MAX_VALUE,f=r.board._deadSpace,d=0;d<s.length;d++){var u=s[d],c=r.board.spaces[u],P=PP64.utils.number.distance(i.x,i.y,c.x,c.y);P<o&&(o=P,f=u)}if(0===r.boardIndex){var v=PP64.romhandler.getDataView();return 1===n?(v.setUint16(3277914,r.curSpaceIndex),v.setUint16(3277994,r.curSpaceIndex),v.setUint16(3277978,f),v.setUint16(3277986,f)):2===n&&(v.setUint16(3277922,r.curSpaceIndex),v.setUint16(3277962,r.curSpaceIndex),v.setUint16(3277942,f),v.setUint16(3277950,f)),[3277776,0]}throw"Can't write Bank to board index "+r.boardIndex};var f=PP64.adapters.events.getEvent("ITEMSHOP");f._parse3=function(e,t){var r=!1;if(0===t.boardIndex){if(3281356!==t.offset)return!1;if(201574479!==e.getUint32(t.offset+68))return!1;r=!0}return!!r},f._write3=function(e,t,r,a){var n=a.curItemShop=a.curItemShop||1;a.curItemShop++;for(var s=PP64.boards.getSpacesOfSubType($spaceSubType.ITEMSHOP,r.board),i=r.curSpace,o=Number.MAX_VALUE,f=r.board._deadSpace,d=0;d<s.length;d++){var u=s[d],c=r.board.spaces[u],P=PP64.utils.number.distance(i.x,i.y,c.x,c.y);P<o&&(o=P,f=u)}if(0===r.boardIndex){var v=PP64.romhandler.getDataView();return 1===n?(v.setUint16(3281518,r.curSpaceIndex),v.setUint16(3281570,r.curSpaceIndex),v.setUint16(3281546,f),v.setUint16(3281558,f)):2===n&&(v.setUint16(3281526,r.curSpaceIndex),v.setUint16(3281610,r.curSpaceIndex),v.setUint16(3281534,f),v.setUint16(3281598,f)),[3281356,0]}throw"Can't write Item Shop to board index "+r.boardIndex}}();
