...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};PP64.boards=function(){var t=0;function r(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:1,n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:PP64.types.BoardType.NORMAL,t={name:"Untitled",description:"Use your Star Power to finish\nthis board.",type:n,difficulty:3,spaces:[],links:{},game:e};switch(e){case 1:t.bg={width:960,height:720,src:!0},t.otherbg={boardselect:!0,boardlogo:!0,largescene:!0,conversation:!0,splashscreen:!0},t.audioIndex=24;break;case 2:t.bg={width:1152,height:864,src:!0},t.animbg=[],t.otherbg={boardselect:!0,boardselecticon:!0,boardlogo:!0,largescene:!0};break;case 3:switch(n){case PP64.types.BoardType.NORMAL:t.bg={width:1152,height:864,src:!0};break;case PP64.types.BoardType.DUEL:t.bg={width:896,height:672,src:!0}}t.otherbg={boardselect:!0,boardlogo:!0,boardlogotext:!0,largescene:!0}}return n===PP64.types.BoardType.DUEL?(t.spaces.push({x:200,y:200,type:$spaceType.DUEL_START_BLUE}),t.spaces.push({x:t.bg.width-200,y:t.bg.height-200,type:$spaceType.DUEL_START_RED})):t.spaces.push({x:t.bg.width-200,y:t.bg.height-200,type:$spaceType.START}),function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"default",t="img/themes/";e.otherbg.boardselect&&(e.otherbg.boardselect=t+n+"/boardselect.png");e.otherbg.boardselecticon&&(e.otherbg.boardselecticon=t+n+"/boardselecticon.png");e.otherbg.boardlogo&&(e.otherbg.boardlogo=t+n+"/boardlogo.png");e.otherbg.boardlogotext&&(e.otherbg.boardlogotext=t+n+"/boardlogotext.png");e.otherbg.largescene&&(e.otherbg.largescene=t+n+"/largescene.png");e.otherbg.conversation&&(e.otherbg.conversation=t+n+"/conversation.png");e.otherbg.splashscreen&&(e.otherbg.splashscreen=t+n+"/splashscreen.png");switch(e.game){case 1:e.bg.src=t+n+"/bg.png";break;case 2:case 3:e.bg.src=t+n+"/bg2.png"}}(t),t}var o=void 0,e=PP64.utils.localstorage.getSavedBoards();function n(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return e||(e=r(n.game||1,n.type||PP64.types.BoardType.NORMAL)),n.rom&&(e._rom=!0),function(e){if(!e.spaces)return;if(!PP64.adapters)return;for(var n=0;n<e.spaces.length;n++){var t=e.spaces[n];if(t.events)for(var r=0;r<t.events.length;r++){var o=t.events[r];if(o.asm&&!PP64.adapters.events.getEvent(o.id))try{PP64.adapters.events.createCustomEvent(o.asm)}catch(r){console.error("Error reading custom event from loaded board: "+r.toString()),t.events.splice(r,1)}}}}(e),o.push(e),PP64.app&&PP64.app.boardsChanged(),o.length-1}function c(){var e=0<arguments.length&&void 0!==arguments[0]&&arguments[0],n=o[t];return e&&(n=function e(){var n=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if("object"!==(void 0===n?"undefined":_typeof(n)))return n;n=JSON.parse(JSON.stringify(n));for(var t in n)n.hasOwnProperty(t)&&("_"===t.charAt(0)&&delete n[t],"object"===_typeof(n[t])&&null!==n[t]&&(n[t]=e(n[t])));return n}(n)),n}function a(e){t=e,PP64.app.currentBoardChanged()}function s(e){return!!e._rom}function i(e,n){var t=2<arguments.length&&void 0!==arguments[2]?arguments[2]:c();return Array.isArray(t.links[e])?"*"===n||void 0===n||0<=t.links[e].indexOf(n):void 0!==t.links[e]&&null!==t.links[e]&&("*"===n||void 0===n||t.links[e]===n)}function l(e,n,t){e.events=e.events||[],n&&(t?e.events.unshift(n):e.events.push(n))}return e&&e.length?(o=[],e.forEach(n)):o=[r(1)],{getCurrentBoard:c,indexOf:function(e){return o.indexOf(e)},getCurrentBoardIndex:function(){return t},setCurrentBoard:a,currentBoardIsROM:function(){return!!c()._rom},boardIsROM:s,getBoardCount:function(){return o.length},getBoards:function(){return o},getROMBoards:function(){return o.filter(function(e){return s(e)})},setBG:function(e){(1<arguments.length&&void 0!==arguments[1]?arguments[1]:c()).bg.src=e},addAnimBG:function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:c();n.animbg=n.animbg||[],n.animbg.push(e)},removeAnimBG:function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:c();!n.animbg||n.animbg.length<=e||e<0||n.animbg.splice(e,1)},addBoard:n,deleteBoard:function(e){isNaN(e)||e<0||e>=o.length||(1===o.length&&n(),o.splice(e,1),e<t?a(t-1):1===o.length?a(0):t===e&&t===o.length&&a(t-1),PP64.app.boardsChanged(),PP64.app.currentBoardChanged())},copyCurrentBoard:function(){var e=o[t],n=JSON.parse(JSON.stringify(e));delete n._rom,n.name="Copy of "+n.name,o.splice(t+1,0,n),PP64.app.boardsChanged()},addSpace:function(e,n,t,r){var o=4<arguments.length&&void 0!==arguments[4]?arguments[4]:c(),a={x:e,y:n,z:0,type:t};void 0!==r&&(a.subtype=r);var s=PP64.adapters.getAdapter(o.game||1);s&&s.hydrateSpace(a);for(var i=0;i<o.spaces.length;i++)if(null===o.spaces)return o.spaces[i]=a,i;return o.spaces.push(a),o.spaces.length-1},removeSpace:function(n){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:c();if(!(n<0||n>=e.spaces.length)){!function(e,n){if(n.links)for(var t in delete n.links[e],n.links){var r=n.links[t];if(Array.isArray(r)){var o=r.indexOf(e);-1!==o&&r.splice(o,1),1===r.length?n.links[t]=r[0]:r.length||delete n.links[t]}else r===e&&delete n.links[t]}}(n,e);var t=e.spaces.length;e.spaces.splice(n,1);for(var r=void 0,o=void 0,a=0;a<t;a++)e.links.hasOwnProperty(a)&&(r=s(a),o=e.links[a],r!==a&&delete e.links[a],Array.isArray(o)?e.links[r]=o.map(s):e.links[r]=s(o))}function s(e){return parseInt(e)>parseInt(n)?e-1:e}},getSpaceIndex:function(e){return(1<arguments.length&&void 0!==arguments[1]?arguments[1]:c()).spaces.indexOf(e)},getStartSpaceIndex:function(e){for(var n=e.spaces,t=0;t<n.length;t++)if(n[t]&&n[t].type===PP64.types.Space.START)return t;return-1},getSpacesOfType:function(e){for(var n=(1<arguments.length&&void 0!==arguments[1]?arguments[1]:c()).spaces,t=[],r=0;r<n.length;r++)n[r]&&n[r].type===e&&t.push(r);return t},getSpacesOfSubType:function(e){for(var n=(1<arguments.length&&void 0!==arguments[1]?arguments[1]:c()).spaces,t=[],r=0;r<n.length;r++)n[r]&&n[r].subtype===e&&t.push(r);return t},hasConnection:i,getConnections:function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:c();return e<0?null:(n.links=n.links||{},Array.isArray(n.links[e])?n.links[e].slice(0):"number"==typeof n.links[e]?[n.links[e]]:[])},addConnection:function(e,n){var t=2<arguments.length&&void 0!==arguments[2]?arguments[2]:c();e===n||i(e,n,t)||(t.links=t.links||{},Array.isArray(t.links[e])?t.links[e].push(n):"number"==typeof t.links[e]?t.links[e]=[t.links[e],n]:0<=n&&(t.links[e]=n))},addAssociation:function(e,n){var t=2<arguments.length&&void 0!==arguments[2]?arguments[2]:c();t.associations=t.associations||{};isNaN(t.spaces[e].subtype),isNaN(t.spaces[n].subtype)},setSpaceRotation:function(e,n){var t=(2<arguments.length&&void 0!==arguments[2]?arguments[2]:c()).spaces[e];if(!t)throw new Error("setSpaceRotation: Invalid space index "+e);t.rotation=Math.round(n)},addEventByIndex:function(e,n,t,r){l(e.spaces[n],t,r)},addEventToSpace:l,removeEventFromSpace:function(e,n){if(e&&n&&e.events){var t=e.events.indexOf(n);-1===t||e.events.splice(t,1)}},getDeadEnds:function(o){var e,a=[],s=(e=o,PP64.utils.obj.copy(e.spaces));function i(e){if(s[e]._seen)return!1;if(!o.links.hasOwnProperty(e))return a.push(e),!0;s[e]._seen=!0;var n=o.links[e],t=void 0;if(Array.isArray(n)){for(var r=0;r<n.length;r++)if(t=i(n[r]))return t}else if(t=i(n))return t}for(var t={},n=0;n<s.length;n++)s[n]&&(t[n]=[]);var r=function(n){PP64.boards.getConnections(n,o).forEach(function(e){t[e].push(Number(n))})};for(var c in o.links)r(c);var l,d,g=PP64.boards.getStartSpaceIndex(o);0<=g&&i(g);for(var p=0;p<s.length;p++)s[p]&&(s[p]._seen||(l=p,!((d=void 0)===d?t[l].length:t[l].length&&(-1===t[l].indexOf(Number(d))||1<t[l].length))&&PP64.boards.hasConnection(p,null,o)&&i(p)));return a},loadBoardsFromROM:function(){var e=PP64.adapters.getROMAdapter();if(e){for(var n=e.loadBoards(),t=0;t<n.length;t++)n[t]._rom=!0,o.push(n[t]);PP64.app.boardsChanged()}},clearBoardsFromROM:function(){for(var e=o.length-1;0<=e;e--)o[e]._rom&&o.splice(e,1);o.length||n()}}}();
