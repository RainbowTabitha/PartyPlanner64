...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};PP64.interaction=function(){function e(e,r){for(var t=PP64.boards.getCurrentBoard(),n=3===t.game?14:8,a=-1,c=0;c<t.spaces.length;c++){var o=t.spaces[c];null!==o&&Math.abs(o.x-e)<=n&&Math.abs(o.y-r)<=n&&(a=c)}return a}function r(e){e.preventDefault(),e.stopPropagation();var r=h===-1?null:PP64.boards.getCurrentBoard().spaces[h];PP64.renderer.updateRightClickMenu(r),h=-1}function t(r){if(!PP64.boards.currentBoardIsROM()){var t=Math.abs(R-B)>5||Math.abs(m-O)>5,p=h;h=-1,R=B=-1,m=O=-1;var i=PP64.boards.getCurrentBoard(),s=p===-1?null:i.spaces[p];if(PP64.app.changeCurrentSpace(s),PP64.renderer.rightClickOpen()&&!t)return PP64.renderer.updateRightClickMenu(s),void(s&&(r.preventDefault(),r.stopPropagation()));if(0===r.button){var d=PP64.app.getCurrentAction(),u=[$actType.LINE,$actType.LINE_STICKY,$actType.MOVE];if(!(u.indexOf(d)>=0)){var P=r.clientX-L.left,y=r.clientY-L.top;if(d===$actType.DELETE||d===$actType.ERASE)s&&s.type!==$spaceType.START?(PP64.boards.removeSpace(p),PP64.app.changeCurrentSpace(null),PP64.renderer.render()):o(P,y);else if(d===$actType.MARK_STAR)a(s);else if(d===$actType.MARK_GATE)c(s);else{if(t&&e(P,y)>=0)return;n(d,P,y,s,t)}}}}}function n(e,r,t,n,a){var c=i(e),o=s(e);if(n)void 0===o||a||(n.subtype===o?delete n.subtype:n.subtype=o),PP64.app.changeCurrentSpace(n);else{var p=PP64.boards.addSpace(r,t,c,o),d=PP64.boards.getCurrentBoard();PP64.app.changeCurrentSpace(d.spaces[p])}PP64.renderer.renderSpaces()}function a(e){e&&(e.star=!e.star,PP64.renderer.renderSpaces(),PP64.app.changeCurrentSpace(e))}function c(e){e&&e.type===$spaceType.OTHER&&(e.gate=!e.gate,PP64.renderer.renderSpaces(),PP64.app.changeCurrentSpace(e))}function o(e,r){var t=PP64.boards.getCurrentBoard(),n=t.spaces,a=t.links,c=!1;for(var o in a){var i=n[o],s=void 0,d=a[o];if(Array.isArray(d)){for(var u=0;u<d.length;)s=n[d[u]],p(i,s,e,r)?(d.splice(u,1),c=!0):u++;1===d.length?d=d[0]:d.length||delete a[o]}else s=n[d],p(i,s,e,r)&&(delete a[o],c=!0)}c&&PP64.renderer.renderConnections()}function p(e,r,t,n){return!(t>e.x&&t>r.x)&&(!(t<e.x&&t<r.x)&&(!(n>e.y&&n>r.y)&&(!(n<e.y&&n<r.y)&&$$number.lineDistance(t,n,e.x,e.y,r.x,r.y)<=4)))}function i(e){var r=$spaceType.OTHER;return e===$actType.ADD_BLUE?r=$spaceType.BLUE:e===$actType.ADD_RED?r=$spaceType.RED:e===$actType.ADD_HAPPENING?r=$spaceType.HAPPENING:e===$actType.ADD_STAR?r=$spaceType.STAR:e===$actType.ADD_BLACKSTAR?r=$spaceType.BLACKSTAR:e===$actType.ADD_MINIGAME?r=$spaceType.MINIGAME:e===$actType.ADD_CHANCE?r=$spaceType.CHANCE:e===$actType.ADD_START?r=$spaceType.START:e===$actType.ADD_SHROOM?r=$spaceType.SHROOM:e===$actType.ADD_BOWSER?r=$spaceType.BOWSER:e===$actType.ADD_ITEM?r=$spaceType.ITEM:e===$actType.ADD_BATTLE?r=$spaceType.BATTLE:e===$actType.ADD_BANK?r=$spaceType.BANK:e===$actType.ADD_ARROW?r=$spaceType.ARROW:e===$actType.ADD_GAMEGUY&&(r=$spaceType.GAMEGUY),r}function s(e){var r=void 0;return e===$actType.ADD_TOAD_CHARACTER?r=$spaceSubType.TOAD:e===$actType.ADD_BOWSER_CHARACTER?r=$spaceSubType.BOWSER:e===$actType.ADD_KOOPA_CHARACTER?r=$spaceSubType.KOOPA:e===$actType.ADD_BOO_CHARACTER?r=$spaceSubType.BOO:e===$actType.ADD_BANK_SUBTYPE?r=$spaceSubType.BANK:e===$actType.ADD_BANKCOIN_SUBTYPE?r=$spaceSubType.BANKCOIN:e===$actType.ADD_ITEMSHOP_SUBTYPE&&(r=$spaceSubType.ITEMSHOP),r}function d(e){var r=e.currentTarget;P(r,e.clientX,e.clientY)}function u(e){var r=e.currentTarget;if(1===e.touches.length){var t=e.touches[0];P(r,t.clientX,t.clientY)}}function P(r,t,n){L=r.getBoundingClientRect(),R=B=t-L.left,m=O=n-L.top,h=e(B,O),PP64.boards.currentBoardIsROM()&&h!==-1&&(PP64.app.changeCurrentAction($actType.MOVE),PP64.boards.copyCurrentBoard(),PP64.boards.setCurrentBoard(PP64.boards.getCurrentBoardIndex()+1)),$$log("Clicked space: "+$$hex(h)+" ("+h+")",PP64.boards.getCurrentBoard().spaces[h])}function y(){_||(_=setTimeout(T,10))}function T(){PP64.renderer.renderConnections(),_=null}function v(){M||(M=setTimeout(l,10))}function l(){PP64.renderer.renderSpaces(),PP64.renderer.renderCurrentSpace(),M=null}function f(e){var r=void 0,t=void 0;if(1===e.touches.length&&h!==-1){e.preventDefault();var n=e.touches[0];r=n.clientX-L.left,t=n.clientY-L.top,A(r,t)}}function C(e){var r=void 0,t=void 0;L&&1===e.buttons&&(r=e.clientX-L.left,t=e.clientY-L.top,A(r,t))}function A(r,t){if(!PP64.boards.currentBoardIsROM()){var n=PP64.app.getCurrentAction();if(h===-1&&n!==$actType.ERASE)return B=r,void(O=t);var a=PP64.boards.getCurrentBoard(),c=a.spaces[h];if(n===$actType.LINE)PP64.renderer.renderConnections(),PP64.renderer.drawConnection(c.x,c.y,r,t),PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(null);else if(n===$actType.LINE_STICKY){var p=e(r,t);if(p!==-1&&p!==h){a.spaces[p];PP64.boards.addConnection(h,p),h=p,PP64.renderer.renderConnections()}else PP64.renderer.renderConnections(),PP64.renderer.drawConnection(c.x,c.y,r,t)}else if(n===$actType.ASSOCIATE)PP64.renderer.renderConnections(),PP64.renderer.drawAssociation(c.x,c.y,r,t);else if(n===$actType.ERASE){var i=e(r,t);i!==-1&&a.spaces[i].type!==$spaceType.START?(PP64.boards.removeSpace(i),PP64.app.changeCurrentSpace(null),PP64.renderer.render()):o(r,t)}else if(n!==$actType.DELETE){var s=r-B,d=t-O;c.x+=s,c.y+=d,y(),v(),PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(c)}B=r,O=t}}function E(e){0===e.button&&g()}function $(e){1===e.touches.length&&g()}function g(){if(!PP64.boards.currentBoardIsROM()&&h!==-1){var r=PP64.app.getCurrentAction(),t=void 0,n=void 0;r===$actType.LINE?(t=e(B,O),t!==-1&&t!==h&&(n=PP64.boards.getCurrentBoard().spaces[t],PP64.boards.addConnection(h,t)),PP64.renderer.renderConnections()):r===$actType.ASSOCIATE&&(t=e(B,O),t!==-1&&(n=PP64.boards.getCurrentBoard().spaces[t],void 0===n.subtype),PP64.renderer.renderConnections())}}function S(r){if(r.preventDefault(),!PP64.boards.currentBoardIsROM()){PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(null);var t=void 0;try{t=JSON.parse(r.dataTransfer.getData("text"))}catch(e){return}if("object"===("undefined"==typeof t?"undefined":_typeof(t))&&t.action){var a=r.currentTarget;L=a.getBoundingClientRect();var c=r.clientX-L.left,o=r.clientY-L.top,p=e(c,o),i=PP64.boards.getCurrentBoard(),s=p===-1?null:i.spaces[p];n(t.action.type,c,o,s,!1)}}}function b(e){e.preventDefault()}function D(e){var r=PP64.app.getCurrentSpace();if(r){var t=PP64.boards.getCurrentBoard();if("38"==e.keyCode)r.y=Math.max(r.y-1,0),PP64.app.changeCurrentSpace(r);else if("40"==e.keyCode)r.y=Math.min(r.y+1,t.bg.height),PP64.app.changeCurrentSpace(r);else if("37"==e.keyCode)r.x=Math.max(r.x-1,0),PP64.app.changeCurrentSpace(r);else if("39"==e.keyCode)r.x=Math.min(r.x+1,t.bg.width),PP64.app.changeCurrentSpace(r);else{if("46"!=e.keyCode)return;if(void 0!==r.subtype)delete r.subtype,PP64.app.changeCurrentSpace(r);else{var n=PP64.boards.getSpaceIndex(r,t);PP64.boards.removeSpace(n,t),PP64.app.changeCurrentSpace(null)}}}}var h=-1,R=-1,m=-1,B=-1,O=-1,L=null,_=void 0,M=void 0;return{attachToCanvas:function(e){e.addEventListener("contextmenu",r,!1),e.addEventListener("click",t,!1),e.addEventListener("mousedown",d,!1),e.addEventListener("mousemove",C,!1),e.addEventListener("mouseup",E,!1),e.addEventListener("touchstart",u,!1),e.addEventListener("touchmove",f,!1),e.addEventListener("touchend",$,!1),e.addEventListener("drop",S,!1),e.addEventListener("dragover",b,!1),e.addEventListener("keydown",D,!1)},detachFromCanvas:function(e){e.removeEventListener("contextmenu",r),e.removeEventListener("click",t),e.removeEventListener("mousedown",d),e.removeEventListener("mousemove",C),e.removeEventListener("mouseup",E),e.removeEventListener("touchstart",u),e.removeEventListener("touchmove",f),e.removeEventListener("touchend",$),e.removeEventListener("drop",S),e.removeEventListener("dragover",b),e.removeEventListener("keydown",D)}}}();
