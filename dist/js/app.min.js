...
"use strict";var _slicedToArray=function(A,E){if(Array.isArray(A))return A;if(Symbol.iterator in Object(A))return function(A,E){var e=[],D=!0,t=!1,T=void 0;try{for(var _,r=A[Symbol.iterator]();!(D=(_=r.next()).done)&&(e.push(_.value),!E||e.length!==E);D=!0);}catch(A){t=!0,T=A}finally{try{!D&&r.return&&r.return()}finally{if(t)throw T}}return e}(A,E);throw new TypeError("Invalid attempt to destructure non-iterable instance")};PP64.types={View:{EDITOR:0,DETAILS:1,SETTINGS:2,ABOUT:3,MODELS:4,PATCHES:5,STRINGS:6,EVENTS:7,CREATEEVENT:8},Space:{OTHER:0,BLUE:1,RED:2,MINIGAME:3,HAPPENING:4,STAR:5,CHANCE:6,START:7,SHROOM:8,BOWSER:9,ITEM:10,BATTLE:11,BANK:12,ARROW:13,BLACKSTAR:14,GAMEGUY:15,DUEL_BASIC:16,DUEL_START_BLUE:17,DUEL_START_RED:18,DUEL_POWERUP:19,DUEL_REVERSE:20},isKnownSpaceType:function(A){for(var E in $spaceType)if($spaceType[E]===A)return!0;return!1},SpaceSubtype:{TOAD:0,BOWSER:1,KOOPA:2,BOO:3,GOOMBA:4,BANK:5,BANKCOIN:6,ITEMSHOP:7,GATE:8},BoardType:{NORMAL:"NORMAL",DUEL:"DUEL"},Action:{MOVE:0,LINE:1,LINE_STICKY:2,ERASE:4,ROM_LOAD:5,ROM_UNLOAD:6,BOARD_LOAD:7,BOARD_SAVE:8,BOARD_NEW:9,BOARD_WRITE:10,BOARD_DETAILS:11,BOARD_EDITOR:12,BOARD_COPY:13,DUMP_LOAD:13.1,DUMP_SAVE:13.2,MODEL_VIEWER:13.3,STRINGS_EDITOR:13.4,EVENTS:13.5,CREATEEVENT:13.6,BACK_TO_EVENTS:13.7,SAVE_EVENT:13.8,EVENT_LOAD:13.9,SET_BG:14,SCREENSHOT:14.1,ROM_SAVE:15,SETTINGS:15.1,ABOUT:15.2,PATCHES:15.3,ADD_OTHER:16,ADD_BLUE:17,ADD_RED:18,ADD_MINIGAME:19,ADD_HAPPENING:20,ADD_STAR:21,ADD_BLACKSTAR:21.2,ADD_START:21.3,ADD_CHANCE:22,ADD_SHROOM:23,ADD_BOWSER:24,ADD_TOAD_CHARACTER:25,ADD_BOWSER_CHARACTER:26,ADD_KOOPA_CHARACTER:27,ADD_BOO_CHARACTER:28,ADD_ITEM:29,ADD_BATTLE:30,ADD_BANK:31,ADD_GAMEGUY:32,ADD_ARROW:32.2,MARK_STAR:33,MARK_GATE:33.1,ADD_BANK_SUBTYPE:34,ADD_BANKCOIN_SUBTYPE:35,ADD_ITEMSHOP_SUBTYPE:36,ADD_DUEL_BASIC:37,ADD_DUEL_REVERSE:38,ADD_DUEL_POWERUP:39,ADD_DUEL_START_BLUE:40,ADD_DUEL_START_RED:41},Game:{MP1_USA:"CLBE",MP1_JPN:"CLBJ",MP1_PAL:"NLBP",MP2_USA:"NMWE",MP2_JPN:"NMWJ",MP2_PAL:"NMWP",MP3_USA:"NMVE",MP3_JPN:"NMVJ",MP3_PAL:"NMVP"},getGameName:function(A){var E=!0,e=!1,D=void 0;try{for(var t,T=Object.entries(PP64.types.Game)[Symbol.iterator]();!(E=(t=T.next()).done);E=!0){var _=_slicedToArray(t.value,2),r=_[0];if(_[1]===A)return r}}catch(A){e=!0,D=A}finally{try{!E&&T.return&&T.return()}finally{if(e)throw D}}return null},EventActivationType:{WALKOVER:1,LANDON:3,BEGINORWALKOVER:8},EventExecutionType:{DIRECT:1,PROCESS:2},getExecutionTypeName:function(A){switch(A){case 1:return"Direct";case 2:return"Process"}throw new Error("Unknown execution type "+A+".")},getExecutionTypeByName:function(A){switch(A){case"Direct":return 1;case"Process":return 2}},ValidationLevel:{ERROR:1,WARNING:2}};var $viewType=PP64.types.View,$actType=PP64.types.Action,$gameType=PP64.types.Game,$spaceType=PP64.types.Space,$spaceSubType=PP64.types.SpaceSubtype,$activationType=PP64.types.EventActivationType,$executionType=PP64.types.EventExecutionType,$validationLevel=PP64.types.ValidationLevel;
...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};PP64.boards=function(){var r=0;function t(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:1,n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:PP64.types.BoardType.NORMAL,r={name:"Untitled",description:"Use your Star Power to finish\nthis board.",type:n,difficulty:3,spaces:[],links:{},game:e};switch(e){case 1:r.bg={width:960,height:720,src:!0},r.otherbg={boardselect:!0,boardlogo:!0,largescene:!0,conversation:!0,splashscreen:!0},r.audioIndex=24;break;case 2:r.bg={width:1152,height:864,src:!0},r.animbg=[],r.otherbg={boardselect:!0,boardselecticon:!0,boardlogo:!0,largescene:!0};break;case 3:switch(n){case PP64.types.BoardType.NORMAL:r.bg={width:1152,height:864,src:!0};break;case PP64.types.BoardType.DUEL:r.bg={width:896,height:672,src:!0}}r.otherbg={boardselect:!0,boardlogo:!0,boardlogotext:!0,largescene:!0}}return n===PP64.types.BoardType.DUEL?(r.spaces.push({x:200,y:200,type:$spaceType.DUEL_START_BLUE}),r.spaces.push({x:r.bg.width-200,y:r.bg.height-200,type:$spaceType.DUEL_START_RED})):r.spaces.push({x:r.bg.width-200,y:r.bg.height-200,type:$spaceType.START}),function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"default",r="img/themes/";e.otherbg.boardselect&&(e.otherbg.boardselect=r+n+"/boardselect.png");e.otherbg.boardselecticon&&(e.otherbg.boardselecticon=r+n+"/boardselecticon.png");e.otherbg.boardlogo&&(e.otherbg.boardlogo=r+n+"/boardlogo.png");e.otherbg.boardlogotext&&(e.otherbg.boardlogotext=r+n+"/boardlogotext.png");e.otherbg.largescene&&(e.otherbg.largescene=r+n+"/largescene.png");e.otherbg.conversation&&(e.otherbg.conversation=r+n+"/conversation.png");e.otherbg.splashscreen&&(e.otherbg.splashscreen=r+n+"/splashscreen.png");switch(e.game){case 1:e.bg.src=r+n+"/bg.png";break;case 2:case 3:e.bg.src=r+n+"/bg2.png"}}(r),r}var o=void 0,e=PP64.utils.localstorage.getSavedBoards();function n(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return e||(e=t(n.game||1,n.type||PP64.types.BoardType.NORMAL)),n.rom&&(e._rom=!0),function(e){if(!e.spaces)return;if(!PP64.adapters)return;for(var n=0;n<e.spaces.length;n++){var r=e.spaces[n];if(r.events)for(var t=0;t<r.events.length;t++){var o=r.events[t];if(o.asm&&!PP64.adapters.events.getEvent(o.id))try{PP64.adapters.events.createCustomEvent(o.asm)}catch(t){console.error("Error reading custom event from loaded board: "+t.toString()),r.events.splice(t,1)}}}}(e),o.push(e),PP64.app&&PP64.app.boardsChanged(),o.length-1}function c(){var e=0<arguments.length&&void 0!==arguments[0]&&arguments[0],n=o[r];return e&&(n=function e(){var n=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if("object"!==(void 0===n?"undefined":_typeof(n)))return n;n=JSON.parse(JSON.stringify(n));for(var r in n)n.hasOwnProperty(r)&&("_"===r.charAt(0)&&delete n[r],"object"===_typeof(n[r])&&null!==n[r]&&(n[r]=e(n[r])));return n}(n)),n}function s(e){r=e,PP64.app.currentBoardChanged()}function a(e){return!!e._rom}function i(e,n){var r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:c();return Array.isArray(r.links[e])?"*"===n||void 0===n||0<=r.links[e].indexOf(n):void 0!==r.links[e]&&null!==r.links[e]&&("*"===n||void 0===n||r.links[e]===n)}function l(e,n,r){e.events=e.events||[],n&&(r?e.events.unshift(n):e.events.push(n))}return e&&e.length?(o=[],e.forEach(n)):o=[t(1)],{getCurrentBoard:c,indexOf:function(e){return o.indexOf(e)},getCurrentBoardIndex:function(){return r},setCurrentBoard:s,currentBoardIsROM:function(){return!!c()._rom},boardIsROM:a,getBoardCount:function(){return o.length},getBoards:function(){return o},getROMBoards:function(){return o.filter(function(e){return a(e)})},setBG:function(e){(1<arguments.length&&void 0!==arguments[1]?arguments[1]:c()).bg.src=e},addAnimBG:function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:c();n.animbg=n.animbg||[],n.animbg.push(e)},removeAnimBG:function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:c();!n.animbg||n.animbg.length<=e||e<0||n.animbg.splice(e,1)},addBoard:n,deleteBoard:function(e){isNaN(e)||e<0||e>=o.length||(1===o.length&&n(),o.splice(e,1),e<r?s(r-1):1===o.length?s(0):r===e&&r===o.length&&s(r-1),PP64.app.boardsChanged(),PP64.app.currentBoardChanged())},copyCurrentBoard:function(){var e=o[r],n=JSON.parse(JSON.stringify(e));delete n._rom,n.name="Copy of "+n.name,o.splice(r+1,0,n),PP64.app.boardsChanged()},addSpace:function(e,n,r,t){var o=4<arguments.length&&void 0!==arguments[4]?arguments[4]:c(),s={x:e,y:n,z:0,type:r};void 0!==t&&(s.subtype=t);var a=PP64.adapters.getAdapter(o.game||1);a&&a.hydrateSpace(s);for(var i=0;i<o.spaces.length;i++)if(null===o.spaces)return o.spaces[i]=s,i;return o.spaces.push(s),o.spaces.length-1},removeSpace:function(n){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:c();if(!(n<0||n>=e.spaces.length)){!function(e,n){if(n.links)for(var r in delete n.links[e],n.links){var t=n.links[r];if(Array.isArray(t)){var o=t.indexOf(e);-1!==o&&t.splice(o,1),1===t.length?n.links[r]=t[0]:t.length||delete n.links[r]}else t===e&&delete n.links[r]}}(n,e);var r=e.spaces.length;e.spaces.splice(n,1);for(var t=void 0,o=void 0,s=0;s<r;s++)e.links.hasOwnProperty(s)&&(t=a(s),o=e.links[s],t!==s&&delete e.links[s],Array.isArray(o)?e.links[t]=o.map(a):e.links[t]=a(o))}function a(e){return parseInt(e)>parseInt(n)?e-1:e}},getSpaceIndex:function(e){return(1<arguments.length&&void 0!==arguments[1]?arguments[1]:c()).spaces.indexOf(e)},getStartSpaceIndex:function(e){for(var n=e.spaces,r=0;r<n.length;r++)if(n[r]&&n[r].type===PP64.types.Space.START)return r;return-1},getSpacesOfType:function(e){for(var n=(1<arguments.length&&void 0!==arguments[1]?arguments[1]:c()).spaces,r=[],t=0;t<n.length;t++)n[t]&&n[t].type===e&&r.push(t);return r},getSpacesOfSubType:function(e){for(var n=(1<arguments.length&&void 0!==arguments[1]?arguments[1]:c()).spaces,r=[],t=0;t<n.length;t++)n[t]&&n[t].subtype===e&&r.push(t);return r},hasConnection:i,getConnections:function(e){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:c();return e<0?null:(n.links=n.links||{},Array.isArray(n.links[e])?n.links[e].slice(0):"number"==typeof n.links[e]?[n.links[e]]:[])},addConnection:function(e,n){var r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:c();e===n||i(e,n,r)||(r.links=r.links||{},Array.isArray(r.links[e])?r.links[e].push(n):"number"==typeof r.links[e]?r.links[e]=[r.links[e],n]:0<=n&&(r.links[e]=n))},addAssociation:function(e,n){var r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:c();r.associations=r.associations||{};isNaN(r.spaces[e].subtype),isNaN(r.spaces[n].subtype)},addEventByIndex:function(e,n,r,t){l(e.spaces[n],r,t)},addEventToSpace:l,removeEventFromSpace:function(e,n){if(e&&n&&e.events){var r=e.events.indexOf(n);-1===r||e.events.splice(r,1)}},getDeadEnds:function(o){var e,s=[],a=(e=o,PP64.utils.obj.copy(e.spaces));function i(e){if(a[e]._seen)return!1;if(!o.links.hasOwnProperty(e))return s.push(e),!0;a[e]._seen=!0;var n=o.links[e],r=void 0;if(Array.isArray(n)){for(var t=0;t<n.length;t++)if(r=i(n[t]))return r}else if(r=i(n))return r}for(var r={},n=0;n<a.length;n++)a[n]&&(r[n]=[]);var t=function(n){PP64.boards.getConnections(n,o).forEach(function(e){r[e].push(Number(n))})};for(var c in o.links)t(c);var l,d,g=PP64.boards.getStartSpaceIndex(o);0<=g&&i(g);for(var p=0;p<a.length;p++)a[p]&&(a[p]._seen||(l=p,!((d=void 0)===d?r[l].length:r[l].length&&(-1===r[l].indexOf(Number(d))||1<r[l].length))&&PP64.boards.hasConnection(p,null,o)&&i(p)));return s},loadBoardsFromROM:function(){var e=PP64.adapters.getROMAdapter();if(e){for(var n=e.loadBoards(),r=0;r<n.length;r++)n[r]._rom=!0,o.push(n[r]);PP64.app.boardsChanged()}},clearBoardsFromROM:function(){for(var e=o.length-1;0<=e;e--)o[e]._rom&&o.splice(e,1);o.length||n()}}}();
...
"use strict";var _createClass=function(){function n(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(e,t,a){return t&&n(e.prototype,t),a&&n(e,a),e}}();function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}PP64.renderer=function(){PP64.types.isKnownSpaceType;function r(e,t){var a=Math.floor((t.offsetWidth-e.bg.width)/2);a=Math.max(0,a);var n=Math.floor((t.offsetHeight-e.bg.height)/2);return"translateX("+a+"px) translateY("+(n=Math.max(0,n))+"px)"}function s(e,t,a){var n=!(3<arguments.length&&void 0!==arguments[3])||arguments[3];for(var r in n&&t.clearRect(0,0,e.width,e.height),a.links=a.links||{},a.links)for(var s=a.spaces[r].x,o=a.spaces[r].y,i=PP64.boards.getConnections(r,a),c=void 0,l=void 0,p=!1,d=0;d<i.length;d++)c=a.spaces[i[d]].x,l=a.spaces[i[d]].y,(p=u(a.links,i[d],r))&&r>i[d]||h(t,s,o,c,l,p)}function u(e,t,a){var n=e[t];return Array.isArray(n)?0<=n.indexOf(parseInt(a)):n==a}function i(e,t,a){var n=!(3<arguments.length&&void 0!==arguments[3])||arguments[3],r=4<arguments.length&&void 0!==arguments[4]?arguments[4]:{};n&&t.clearRect(0,0,e.width,e.height);for(var s=a.game||1,o=a.type||PP64.types.BoardType.NORMAL,i=0;i<a.spaces.length;i++){var c=a.spaces[i];null!==c&&(c.z=c.z||0,l(t,c,s,o,r))}}function l(e,t,a,n){var r=4<arguments.length&&void 0!==arguments[4]?arguments[4]:{},s=t.x,o=t.y,i=t.type,c=t.subtype;switch(i){case $spaceType.OTHER:if(r.skipHiddenSpaces)break;3===a?PP64.spaces.drawOther3(e,s,o):PP64.spaces.drawOther(e,s,o);break;case $spaceType.BLUE:3===a?PP64.spaces.drawBlue3(e,s,o):PP64.spaces.drawBlue(e,s,o);break;case $spaceType.RED:3===a?PP64.spaces.drawRed3(e,s,o):PP64.spaces.drawRed(e,s,o);break;case $spaceType.MINIGAME:n===PP64.types.BoardType.DUEL?PP64.spaces.drawMiniGameDuel3(e,s,o):PP64.spaces.drawMiniGame(e,s,o);break;case $spaceType.HAPPENING:3===a?n===PP64.types.BoardType.DUEL?PP64.spaces.drawHappeningDuel3(e,s,o):PP64.spaces.drawHappening3(e,s,o):PP64.spaces.drawHappening(e,s,o);break;case $spaceType.STAR:3===a?PP64.spaces.drawStar3(e,s,o):PP64.spaces.drawStar(e,s,o);break;case $spaceType.CHANCE:3===a?PP64.spaces.drawChance3(e,s,o):2===a?PP64.spaces.drawChance2(e,s,o):PP64.spaces.drawChance(e,s,o);break;case $spaceType.START:if(r.skipHiddenSpaces)break;3===a?PP64.spaces.drawStart3(e,s,o):PP64.spaces.drawStart(e,s,o);break;case $spaceType.SHROOM:PP64.spaces.drawShroom(e,s,o);break;case $spaceType.BOWSER:3===a?PP64.spaces.drawBowser3(e,s,o):PP64.spaces.drawBowser(e,s,o);break;case $spaceType.ITEM:3===a?PP64.spaces.drawItem3(e,s,o):PP64.spaces.drawItem2(e,s,o);break;case $spaceType.BATTLE:3===a?PP64.spaces.drawBattle3(e,s,o):PP64.spaces.drawBattle2(e,s,o);break;case $spaceType.BANK:3===a?PP64.spaces.drawBank3(e,s,o):PP64.spaces.drawBank2(e,s,o);break;case $spaceType.ARROW:PP64.spaces.drawArrow(e,s,o,a);break;case $spaceType.BLACKSTAR:PP64.spaces.drawBlackStar2(e,s,o);break;case $spaceType.GAMEGUY:n===PP64.types.BoardType.DUEL?PP64.spaces.drawGameGuyDuel3(e,s,o):PP64.spaces.drawGameGuy3(e,s,o);break;case $spaceType.DUEL_BASIC:PP64.spaces.drawDuelBasic(e,s,o);break;case $spaceType.DUEL_START_BLUE:if(r.skipHiddenSpaces)break;PP64.spaces.drawStartDuelBlue(e,s,o);break;case $spaceType.DUEL_START_RED:if(r.skipHiddenSpaces)break;PP64.spaces.drawStartDuelRed(e,s,o);break;case $spaceType.DUEL_POWERUP:PP64.spaces.drawDuelPowerup(e,s,o);break;case $spaceType.DUEL_REVERSE:PP64.spaces.drawDuelReverse(e,s,o);break;default:PP64.spaces.drawUnknown(e,s,o)}if(r.skipCharacters||function(e,t,a,n,r){n===$spaceSubType.TOAD&&(3===r?e.drawImage(PP64.images.get("mstarImg"),t-15,a-22):e.drawImage(PP64.images.get("toadImg"),t-9,a-22));n===$spaceSubType.BOWSER&&e.drawImage(PP64.images.get("bowserImg"),t-27,a-45);n===$spaceSubType.KOOPA&&e.drawImage(PP64.images.get("koopaImg"),t-12,a-22);n===$spaceSubType.BOO&&e.drawImage(PP64.images.get("booImg"),t-13,a-17);n===$spaceSubType.GOOMBA&&e.drawImage(PP64.images.get("goombaImg"),t-8,a-12);n===$spaceSubType.BANK&&(2===r?e.drawImage(PP64.images.get("bank2Img"),t-9,a-10):e.drawImage(PP64.images.get("bank3Img"),t-17,a-20));n===$spaceSubType.BANKCOIN&&e.drawImage(PP64.images.get("bankcoinImg"),t-10,a-9);n===$spaceSubType.ITEMSHOP&&(2===r?e.drawImage(PP64.images.get("itemShop2Img"),t-9,a-10):e.drawImage(PP64.images.get("itemShop3Img"),t-16,a-20))}(e,s,o,c,a),!r.skipBadges){var l=3===a?5:2,p=3===a?16:12;if(t.events&&t.events.length){var d=o+l;i===$spaceType.START&&(d-=p),e.drawImage(PP64.images.get("eventImg"),s+l,d)}if(t.star){var u=o+l;i===$spaceType.START&&(u-=p),e.drawImage(PP64.images.get("starImg"),s-l-9,u)}if(t.subtype===$spaceSubType.GATE){var h=s-l-9,g=o+l-5;e.drawImage(PP64.images.get("gateImg"),h,g)}}if($$debug){e.save();var f=PP64.boards.getSpaceIndex(t);e.fillStyle="white",e.strokeStyle="black",e.lineWidth=2,e.font="bold 6pt Courier New",e.textAlign="center";var P=f.toString();e.strokeText(P,s,o-2),e.fillText(P,s,o-2),P=$$hex(f),e.strokeText(P,s,o+8),e.fillText(P,s,o+8),e.restore()}}var p=Math.PI/1;function h(e,t,a,n,r,s){e.save(),e.beginPath(),e.strokeStyle="rgba(255, 185, 105, 0.75)",e.lineCap="round",e.lineWidth=8,e.moveTo(t,a),e.lineTo(n,r),e.stroke();var o=(t+n)/2,i=(a+r)/2;e.translate(o,i),e.rotate(-Math.atan2(t-o,a-i)+p),e.fillStyle="#A15000";var c=s?3:0;e.moveTo(-4,-2+c),e.lineTo(0,2+c),e.lineTo(4,-2+c),e.fill(),s&&(e.moveTo(-4,2-c),e.lineTo(0,-2-c),e.lineTo(4,2-c),e.fill()),e.restore()}var a=void 0,t=function(e){function o(){var e,t,a;_classCallCheck(this,o);for(var n=arguments.length,r=Array(n),s=0;s<n;s++)r[s]=arguments[s];return(t=a=_possibleConstructorReturn(this,(e=o.__proto__||Object.getPrototypeOf(o)).call.apply(e,[this].concat(r)))).state={},_possibleConstructorReturn(a,t)}return _inherits(o,React.Component),_createClass(o,[{key:"componentDidMount",value:function(){this.renderContent(),a=this}},{key:"componentWillUnmount",value:function(){a=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var e=this.props.board,t=this.getImage(),a=r(e,t.parentElement);t.style.transform=a,t._src===e.bg.src&&t.width===e.bg.width&&t.height===e.bg.height||(t.width=e.bg.width,t.height=e.bg.height,this.setSource(e.bg.src,t))}},{key:"getImage",value:function(){return ReactDOM.findDOMNode(this)}},{key:"setSource",value:function(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:this.getImage();t.src=e,t._src=e}},{key:"render",value:function(){return React.createElement("img",{className:"editor_bg"})}}]),o}(),e=void 0,n=-1;function o(){e&&clearInterval(e),e=null,n=-1,PP64.renderer.renderBG()}function c(){var e=PP64.boards.getCurrentBoard(),t=e.animbg;a&&t&&t.length?(0<=n&&n<t.length?(a.setSource(t[n]),n++):n=-1,-1===n&&(a.setSource(e.bg.src),n++)):o()}var d=void 0,g=function(e){function o(){var e,t,a;_classCallCheck(this,o);for(var n=arguments.length,r=Array(n),s=0;s<n;s++)r[s]=arguments[s];return(t=a=_possibleConstructorReturn(this,(e=o.__proto__||Object.getPrototypeOf(o)).call.apply(e,[this].concat(r)))).state={},_possibleConstructorReturn(a,t)}return _inherits(o,React.Component),_createClass(o,[{key:"componentDidMount",value:function(){this.renderContent(),d=this}},{key:"componentWillUnmount",value:function(){d=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var e=ReactDOM.findDOMNode(this),t=e.parentElement,a=this.props.board,n=r(a,t);e.style.transform=n,e.width===a.bg.width&&e.height===a.bg.height||(e.width=a.bg.width,e.height=a.bg.height),s(e,e.getContext("2d"),a)}},{key:"render",value:function(){return React.createElement("canvas",{className:"editor_line_canvas"})}}]),o}(),f=void 0,P=function(e){function o(){var e,t,a;_classCallCheck(this,o);for(var n=arguments.length,r=Array(n),s=0;s<n;s++)r[s]=arguments[s];return(t=a=_possibleConstructorReturn(this,(e=o.__proto__||Object.getPrototypeOf(o)).call.apply(e,[this].concat(r)))).state={},_possibleConstructorReturn(a,t)}return _inherits(o,React.Component),_createClass(o,[{key:"componentDidMount",value:function(){this.renderContent(),f=this}},{key:"componentWillUnmount",value:function(){f=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var e=ReactDOM.findDOMNode(this),t=e.parentElement,a=this.props.board,n=r(a,t);e.style.transform=n,e.width===a.bg.width&&e.height===a.bg.height||(e.width=a.bg.width,e.height=a.bg.height),function(e,t,a){if(t.clearRect(0,0,e.width,e.height),a&&a.length)for(var n=0;n<a.length;n++){var r=a[n];if(r){t.save(),t.beginPath();var s=3===PP64.boards.getCurrentBoard().game?18:12;t.arc(r.x,r.y,s,0,2*Math.PI),t.setLineDash([2,2]),t.lineWidth=2,t.fillStyle="rgba(47, 70, 95, 0.35)",t.strokeStyle="rgba(47, 70, 95, 1)",t.fill(),t.stroke(),t.restore()}}}(e,e.getContext("2d"),this.props.selectedSpaces)}},{key:"highlightSpaces",value:function(e){var t=ReactDOM.findDOMNode(this);!function(e,t,a){for(var n=PP64.boards.getCurrentBoard(),r=3===n.game?18:12,s=0;s<a.length;s++){var o=n.spaces[a[s]];o&&(t.save(),t.beginPath(),t.arc(o.x,o.y,r,0,2*Math.PI),t.shadowColor="rgba(225, 225, 225, 1)",t.shadowBlur=2,t.fillStyle="rgba(255, 0, 0, 0.85)",t.fill(),t.restore())}}(0,t.getContext("2d"),e)}},{key:"render",value:function(){return React.createElement("canvas",{className:"editor_current_space_canvas"})}}]),o}(),m=void 0,b=function(e){function o(){var e,t,s;_classCallCheck(this,o);for(var a=arguments.length,n=Array(a),r=0;r<a;r++)n[r]=arguments[r];return(t=s=_possibleConstructorReturn(this,(e=o.__proto__||Object.getPrototypeOf(o)).call.apply(e,[this].concat(n)))).state={},s.drawSelectionBox=function(e,t,a,n){var r=ReactDOM.findDOMNode(s).getContext("2d");r.save(),r.beginPath(),r.fillStyle="rgba(47, 70, 95, 0.5)",r.strokeStyle="rgba(47, 70, 95, 1)",r.fillRect(Math.min(e,a),Math.min(t,n),Math.abs(e-a),Math.abs(t-n)),r.strokeRect(Math.min(e,a),Math.min(t,n),Math.abs(e-a),Math.abs(t-n)),r.restore()},_possibleConstructorReturn(s,t)}return _inherits(o,React.Component),_createClass(o,[{key:"componentDidMount",value:function(){var e=ReactDOM.findDOMNode(this);PP64.interaction.attachToCanvas(e),this.renderContent(),m=this}},{key:"componentWillUnmount",value:function(){var e=ReactDOM.findDOMNode(this);PP64.interaction.detachFromCanvas(e),m=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var e=ReactDOM.findDOMNode(this),t=e.parentElement,a=this.props.board,n=r(a,t);e.style.transform=n,e.width===a.bg.width&&e.height===a.bg.height||(e.width=a.bg.width,e.height=a.bg.height),i(e,e.getContext("2d"),a)}},{key:"render",value:function(){return React.createElement("canvas",{className:"editor_space_canvas",tabIndex:"-1",onDragOver:this.preventDefault,onDrop:this.onDrop})}}]),o}(),y=void 0,v=function(e){function o(){var e,t,a;_classCallCheck(this,o);for(var n=arguments.length,r=Array(n),s=0;s<n;s++)r[s]=arguments[s];return(t=a=_possibleConstructorReturn(this,(e=o.__proto__||Object.getPrototypeOf(o)).call.apply(e,[this].concat(r)))).state={rightClickSpace:null},_possibleConstructorReturn(a,t)}return _inherits(o,React.Component),_createClass(o,[{key:"componentDidMount",value:function(){this.renderContent(),y=this}},{key:"componentWillUnmount",value:function(){y=null}},{key:"componentDidUpdate",value:function(){this.renderContent()}},{key:"renderContent",value:function(){var e=ReactDOM.findDOMNode(this),t=e.parentElement,a=r(this.props.board,t);e.style.transform=a}},{key:"setRightClickMenu",value:function(e){this.setState({rightClickSpace:e})}},{key:"rightClickOpen",value:function(){return!!this.state.rightClickSpace}},{key:"render",value:function(){var e=void 0;return this.rightClickOpen()&&(e=React.createElement(PP64.rightclick.RightClickMenu,{space:this.state.rightClickSpace})),React.createElement("div",{className:"editor_menu_overlay"},e)}}]),o}();return{render:function(){a&&a.renderContent(),d&&d.renderContent(),f&&f.renderContent(),m&&m.renderContent()},renderBG:function(){a&&a.renderContent()},renderConnections:function(){d&&d.renderContent()},renderSelectedSpaces:function(){f&&f.renderContent()},renderSpaces:function(){m&&m.renderContent()},updateRightClickMenu:function(e){y&&y.setRightClickMenu(e)},rightClickOpen:function(){return!!y&&y.rightClickOpen()},drawConnection:function(e,t,a,n){d&&h(ReactDOM.findDOMNode(d).getContext("2d"),e,t,a,n)},drawAssociation:function(e,t,a,n,r){e.save(),e.beginPath(),e.strokeStyle="rgba(211, 211, 211, 0.75)",e.setLineDash([1,6]),e.lineCap="round",e.lineWidth=4,e.moveTo(t,a),e.lineTo(n,r),e.stroke(),e.restore()},highlightSpaces:function(e){f&&f.highlightSpaces(e)},drawSelectionBox:function(e,t,a,n){m&&m.drawSelectionBox(e,t,a,n)},playAnimation:function(){e||(e=setInterval(c,800))},stopAnimation:o,animationPlaying:function(){return!!e},external:{getBGImage:function(){return a.getImage()},setBGImage:function(e){a.setSource(e)},renderConnections:s,renderSpaces:i},Editor:function(e){function o(){var e,t,a;_classCallCheck(this,o);for(var n=arguments.length,r=Array(n),s=0;s<n;s++)r[s]=arguments[s];return(t=a=_possibleConstructorReturn(this,(e=o.__proto__||Object.getPrototypeOf(o)).call.apply(e,[this].concat(r)))).state={},_possibleConstructorReturn(a,t)}return _inherits(o,React.Component),_createClass(o,[{key:"componentDidMount",value:function(){window.addEventListener("resize",PP64.renderer.render,!1)}},{key:"componentWillUnmount",value:function(){window.removeEventListener("resize",PP64.renderer.render)}},{key:"componentDidUpdate",value:function(){}},{key:"render",value:function(){return React.createElement("div",{className:"editor"},React.createElement(t,{board:this.props.board}),React.createElement(g,{board:this.props.board}),React.createElement(P,{board:this.props.board,selectedSpaces:this.props.selectedSpaces}),React.createElement(b,{board:this.props.board}),React.createElement(v,{board:this.props.board}))}}]),o}()}}();
...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};function _defineProperty(e,a,c){return a in e?Object.defineProperty(e,a,{value:c,enumerable:!0,configurable:!0,writable:!0}):e[a]=c,e}PP64.interaction=function(){var r={},_=!1,i=-1,d=-1,$=-1,u=-1,R=null;function a(e){t(e.currentTarget,e.clientX,e.clientY,e.ctrlKey)}function c(e){if(1===e.touches.length){var a=e.touches[0];t(e.currentTarget,a.clientX,a.clientY,e.ctrlKey)}}function t(e,a,c,t){var r=a-(R=e.getBoundingClientRect()).left,n=c-R.top;i=$=r,d=u=n;var p=U($,u);$$log("Clicked space: "+$$hex(p)+" ("+p+")",PP64.boards.getCurrentBoard().spaces[p]);var s=-1!==p;PP64.boards.currentBoardIsROM()&&s&&(PP64.app.changeCurrentAction($actType.MOVE),PP64.boards.copyCurrentBoard(),PP64.boards.setCurrentBoard(PP64.boards.getCurrentBoardIndex()+1));var T=PP64.app.getCurrentAction();switch(T){case $actType.MOVE:s?t?L(p):g(p)||M(p):O();break;case $actType.ADD_OTHER:case $actType.ADD_BLUE:case $actType.ADD_RED:case $actType.ADD_MINIGAME:case $actType.ADD_HAPPENING:case $actType.ADD_STAR:case $actType.ADD_BLACKSTAR:case $actType.ADD_START:case $actType.ADD_CHANCE:case $actType.ADD_SHROOM:case $actType.ADD_BOWSER:case $actType.ADD_ITEM:case $actType.ADD_BATTLE:case $actType.ADD_BANK:case $actType.ADD_GAMEGUY:case $actType.ADD_ARROW:case $actType.MARK_STAR:case $actType.MARK_GATE:case $actType.ADD_TOAD_CHARACTER:case $actType.ADD_BOWSER_CHARACTER:case $actType.ADD_KOOPA_CHARACTER:case $actType.ADD_BOO_CHARACTER:case $actType.ADD_BANK_SUBTYPE:case $actType.ADD_BANKCOIN_SUBTYPE:case $actType.ADD_ITEMSHOP_SUBTYPE:case $actType.ADD_DUEL_BASIC:case $actType.ADD_DUEL_REVERSE:case $actType.ADD_DUEL_POWERUP:case $actType.ADD_DUEL_START_BLUE:case $actType.ADD_DUEL_START_RED:s?t?L(p):g(p)||M(p):t||O();break;case $actType.LINE:case $actType.LINE_STICKY:s?M(p):O();break;case $actType.ERASE:O()}var D=h(),A=PP64.boards.getCurrentBoard(),o=A.spaces[p];switch(T){case $actType.LINE:if(1===D.length){var y=D[0];PP64.renderer.renderConnections(),PP64.renderer.drawConnection(y.x,y.y,r,n),PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(null)}break;case $actType.LINE_STICKY:if(1===D.length){var E=D[0];if(o&&o!==E){var P=PP64.boards.getSpaceIndex(E,A);PP64.boards.addConnection(P,p),M(p),PP64.renderer.renderConnections()}else PP64.renderer.renderConnections(),PP64.renderer.drawConnection(E.x,E.y,r,n)}break;case $actType.ERASE:-1!==p&&I(A,p)?(PP64.boards.removeSpace(p),PP64.app.changeSelectedSpaces([]),PP64.renderer.render()):m(r,n);break;case $actType.ADD_OTHER:case $actType.ADD_BLUE:case $actType.ADD_RED:case $actType.ADD_MINIGAME:case $actType.ADD_HAPPENING:case $actType.ADD_STAR:case $actType.ADD_BLACKSTAR:case $actType.ADD_START:case $actType.ADD_CHANCE:case $actType.ADD_SHROOM:case $actType.ADD_BOWSER:case $actType.ADD_ITEM:case $actType.ADD_BATTLE:case $actType.ADD_BANK:case $actType.ADD_GAMEGUY:case $actType.ADD_ARROW:case $actType.MARK_STAR:case $actType.MARK_GATE:case $actType.ADD_TOAD_CHARACTER:case $actType.ADD_BOWSER_CHARACTER:case $actType.ADD_KOOPA_CHARACTER:case $actType.ADD_BOO_CHARACTER:case $actType.ADD_BANK_SUBTYPE:case $actType.ADD_BANKCOIN_SUBTYPE:case $actType.ADD_ITEMSHOP_SUBTYPE:case $actType.ADD_DUEL_BASIC:case $actType.ADD_DUEL_REVERSE:case $actType.ADD_DUEL_POWERUP:case $actType.ADD_DUEL_START_BLUE:case $actType.ADD_DUEL_START_RED:N(T,r,n,o,!1,t)&&L(-1!==p?p:A.spaces.length-1);break;case $actType.MOVE:default:_=s,PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(D[0])}}function n(e){if(1===e.touches.length&&b()){e.preventDefault();var a=e.touches[0];s(a.clientX-R.left,a.clientY-R.top)}}function p(e){R&&1===e.buttons&&s(e.clientX-R.left,e.clientY-R.top)}function s(e,a){if(!PP64.boards.currentBoardIsROM()){var c=PP64.app.getCurrentAction(),t=h(),r=PP64.boards.getCurrentBoard(),n=U(e,a);switch(c){case $actType.LINE:if(1===t.length){var p=t[0];PP64.renderer.renderConnections(),PP64.renderer.drawConnection(p.x,p.y,e,a),PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(null)}break;case $actType.LINE_STICKY:if(1===t.length){var s=t[0],T=r.spaces[n];if(T&&T!==s){var D=PP64.boards.getSpaceIndex(s,r);PP64.boards.addConnection(D,n),M(n),PP64.renderer.renderConnections()}else PP64.renderer.renderConnections(),PP64.renderer.drawConnection(s.x,s.y,e,a)}break;case $actType.ERASE:-1!==n&&I(r,n)?(PP64.boards.removeSpace(n),PP64.app.changeSelectedSpaces([]),PP64.renderer.render()):m(e,a);break;case $actType.MOVE:case $actType.ADD_OTHER:case $actType.ADD_BLUE:case $actType.ADD_RED:case $actType.ADD_MINIGAME:case $actType.ADD_HAPPENING:case $actType.ADD_STAR:case $actType.ADD_BLACKSTAR:case $actType.ADD_START:case $actType.ADD_CHANCE:case $actType.ADD_SHROOM:case $actType.ADD_BOWSER:case $actType.ADD_ITEM:case $actType.ADD_BATTLE:case $actType.ADD_BANK:case $actType.ADD_GAMEGUY:case $actType.ADD_ARROW:case $actType.MARK_STAR:case $actType.MARK_GATE:case $actType.ADD_TOAD_CHARACTER:case $actType.ADD_BOWSER_CHARACTER:case $actType.ADD_KOOPA_CHARACTER:case $actType.ADD_BOO_CHARACTER:case $actType.ADD_BANK_SUBTYPE:case $actType.ADD_BANKCOIN_SUBTYPE:case $actType.ADD_ITEMSHOP_SUBTYPE:case $actType.ADD_DUEL_BASIC:case $actType.ADD_DUEL_REVERSE:case $actType.ADD_DUEL_POWERUP:case $actType.ADD_DUEL_START_BLUE:case $actType.ADD_DUEL_START_RED:default:var A=!_&&c===$actType.MOVE;if(!A&&t.length){var o=e-$,y=a-u;t.forEach(function(e){var a=e.x+o;e.x=Math.max(0,Math.min(a,r.bg.width));var c=e.y+y;e.y=Math.max(0,Math.min(c,r.bg.height))}),C||(C=setTimeout(l,10)),f||(f=setTimeout(v,10)),PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(t[0])}A&&function(e,a){if(-1===i||-1===d)return;O();for(var c=PP64.boards.getCurrentBoard().spaces,t=0;t<c.length;t++){var r=c[t];$$number.pointFallsWithin(r.x,r.y,i,d,e,a)&&L(t,!0)}B(),PP64.renderer.drawSelectionBox(i,d,e,a)}(e,a)}$=e,u=a}}function T(e){0===e.button&&A()}function D(e){1===e.touches.length&&A()}function A(){if(!PP64.boards.currentBoardIsROM()){var e=PP64.app.getCurrentAction();if(_||e!==$actType.MOVE||PP64.renderer.renderSpaces(),b()){var a=h();if(e===$actType.LINE){var c=U($,u);if(-1!==c&&-1===a.indexOf(c))for(var t in r)PP64.boards.addConnection(parseInt(t),c);PP64.renderer.renderConnections()}}}}function o(e){if(!PP64.boards.currentBoardIsROM()){var a=5<Math.abs(i-$)||5<Math.abs(d-u),c=0<Math.abs(i-$)||0<Math.abs(d-u),t=h();i=$=-1,d=u=-1;var r=e.ctrlKey,n=U(e.clientX-R.left,e.clientY-R.top),p=PP64.boards.getCurrentBoard(),s=-1===n?null:p.spaces[n];if(0===e.button)switch(PP64.app.getCurrentAction()){case $actType.MOVE:case $actType.ADD_OTHER:case $actType.ADD_BLUE:case $actType.ADD_RED:case $actType.ADD_MINIGAME:case $actType.ADD_HAPPENING:case $actType.ADD_STAR:case $actType.ADD_BLACKSTAR:case $actType.ADD_START:case $actType.ADD_CHANCE:case $actType.ADD_SHROOM:case $actType.ADD_BOWSER:case $actType.ADD_ITEM:case $actType.ADD_BATTLE:case $actType.ADD_BANK:case $actType.ADD_GAMEGUY:case $actType.ADD_ARROW:case $actType.MARK_GATE:case $actType.ADD_TOAD_CHARACTER:case $actType.ADD_BOWSER_CHARACTER:case $actType.ADD_KOOPA_CHARACTER:case $actType.ADD_BOO_CHARACTER:case $actType.ADD_BANK_SUBTYPE:case $actType.ADD_BANKCOIN_SUBTYPE:case $actType.ADD_ITEMSHOP_SUBTYPE:case $actType.ADD_DUEL_BASIC:case $actType.ADD_DUEL_REVERSE:case $actType.ADD_DUEL_POWERUP:case $actType.ADD_DUEL_START_BLUE:case $actType.ADD_DUEL_START_RED:c||r||(s?M(n):O());break;case $actType.MARK_STAR:a||function(e){if(!e||!e.length)return;e.forEach(function(e){e.star=!e.star}),PP64.renderer.renderSpaces(),PP64.app.changeSelectedSpaces(e)}(t);break;case $actType.LINE:case $actType.LINE_STICKY:PP64.renderer.renderConnections();break;case $actType.ERASE:}}}function y(e){e.preventDefault(),e.stopPropagation();var a=h(),c=1!==a.length?null:a[0];PP64.renderer.updateRightClickMenu(c)}function E(e){if(e.preventDefault(),!PP64.boards.currentBoardIsROM()){PP64.renderer.rightClickOpen()&&PP64.renderer.updateRightClickMenu(null);var a=void 0;try{a=JSON.parse(e.dataTransfer.getData("text"))}catch(e){return}if(O(),"object"===(void 0===a?"undefined":_typeof(a))&&a.action){var c=e.currentTarget;R=c.getBoundingClientRect();var t=e.clientX-R.left,r=e.clientY-R.top,n=U(t,r),p=PP64.boards.getCurrentBoard(),s=-1===n?null:p.spaces[n];N(a.action.type,t,r,s,!1,!1)}}}function P(e){var a=PP64.app.getSelectedSpaces();if(a&&a.length){var c=PP64.boards.getCurrentBoard();if(38===e.keyCode)a.forEach(function(e){e.y=Math.max(e.y-1,0)}),PP64.app.changeSelectedSpaces(a);else if(40===e.keyCode)a.forEach(function(e){e.y=Math.min(e.y+1,c.bg.height)}),PP64.app.changeSelectedSpaces(a);else if(37===e.keyCode)a.forEach(function(e){e.x=Math.max(e.x-1,0)}),PP64.app.changeSelectedSpaces(a);else if(39===e.keyCode)a.forEach(function(e){e.x=Math.min(e.x+1,c.bg.width)}),PP64.app.changeSelectedSpaces(a);else if(46===e.keyCode){var t=!1;a.forEach(function(e){void 0!==e.subtype&&(t=!0)}),a.forEach(function(e){if(t)void 0!==e.subtype&&delete e.subtype;else{var a=PP64.boards.getSpaceIndex(e,c);I(c,a)&&PP64.boards.removeSpace(a,c)}}),t?PP64.app.changeSelectedSpaces(a):PP64.app.changeSelectedSpaces([])}}}function S(e){if(0===e.button&&!PP64.boards.currentBoardIsROM()){var a=PP64.app.getCurrentAction();!_&&a===$actType.MOVE&&(PP64.renderer.renderSpaces(),i=$=-1,d=u=-1)}}var C=void 0;function l(){PP64.renderer.renderConnections(),C=null}var f=void 0;function v(){PP64.renderer.renderSpaces(),PP64.renderer.renderSelectedSpaces(),f=null}function O(){r={},PP64.app.changeSelectedSpaces([])}function B(){PP64.app.changeSelectedSpaces(h())}function h(){var e=PP64.boards.getCurrentBoard(),a=[];for(var c in r){var t=e.spaces[c];a.push(t)}return a}function b(){for(var e in r)return!0;return!1}function g(e){return!!r[e]}function L(e,a){r||(r={}),r[e]=!0,a||B()}function M(e){r=_defineProperty({},e,!0),B()}function U(e,a){for(var c=PP64.boards.getCurrentBoard(),t=3===PP64.boards.getCurrentBoard().game?14:8,r=-1,n=0;n<c.spaces.length;n++){var p=c.spaces[n];p&&(Math.abs(p.x-e)<=t&&Math.abs(p.y-a)<=t&&(r=n))}return r}function I(e,a){var c=e.spaces[a];return!!c&&(c.type!==$spaceType.START||1<PP64.boards.getSpacesOfType($spaceType.START,e).length)}function N(e,a,c,t,r,n){var p=function(e){var a=$spaceType.OTHER;e===$actType.ADD_BLUE?a=$spaceType.BLUE:e===$actType.ADD_RED?a=$spaceType.RED:e===$actType.ADD_HAPPENING?a=$spaceType.HAPPENING:e===$actType.ADD_STAR?a=$spaceType.STAR:e===$actType.ADD_BLACKSTAR?a=$spaceType.BLACKSTAR:e===$actType.ADD_MINIGAME?a=$spaceType.MINIGAME:e===$actType.ADD_CHANCE?a=$spaceType.CHANCE:e===$actType.ADD_START?a=$spaceType.START:e===$actType.ADD_SHROOM?a=$spaceType.SHROOM:e===$actType.ADD_BOWSER?a=$spaceType.BOWSER:e===$actType.ADD_ITEM?a=$spaceType.ITEM:e===$actType.ADD_BATTLE?a=$spaceType.BATTLE:e===$actType.ADD_BANK?a=$spaceType.BANK:e===$actType.ADD_ARROW?a=$spaceType.ARROW:e===$actType.ADD_GAMEGUY?a=$spaceType.GAMEGUY:e===$actType.ADD_DUEL_BASIC?a=$spaceType.DUEL_BASIC:e===$actType.ADD_DUEL_REVERSE?a=$spaceType.DUEL_REVERSE:e===$actType.ADD_DUEL_POWERUP?a=$spaceType.DUEL_POWERUP:e===$actType.ADD_DUEL_START_BLUE?a=$spaceType.DUEL_START_BLUE:e===$actType.ADD_DUEL_START_RED&&(a=$spaceType.DUEL_START_RED);return a}(e),s=function(e){var a=void 0;e===$actType.ADD_TOAD_CHARACTER?a=$spaceSubType.TOAD:e===$actType.ADD_BOWSER_CHARACTER?a=$spaceSubType.BOWSER:e===$actType.ADD_KOOPA_CHARACTER?a=$spaceSubType.KOOPA:e===$actType.ADD_BOO_CHARACTER?a=$spaceSubType.BOO:e===$actType.ADD_BANK_SUBTYPE?a=$spaceSubType.BANK:e===$actType.ADD_BANKCOIN_SUBTYPE?a=$spaceSubType.BANKCOIN:e===$actType.ADD_ITEMSHOP_SUBTYPE?a=$spaceSubType.ITEMSHOP:e===$actType.MARK_GATE&&(a=$spaceSubType.GATE);return a}(e),T=!1;if(t)void 0===s||r||(t.type!==$spaceType.OTHER&&s===$spaceSubType.GATE||(t.subtype===s?delete t.subtype:t.subtype=s),PP64.app.changeSelectedSpaces([t]),T=!0);else{var D=PP64.boards.getCurrentBoard(),A=PP64.boards.addSpace(a,c,p,s),o=D.spaces[A];if(n){var y=PP64.app.getSelectedSpaces()||[];y.push(o),PP64.app.changeSelectedSpaces(y)}else PP64.app.changeSelectedSpaces([o]);T=!0}return PP64.renderer.renderSpaces(),T}function m(e,a){var c=PP64.boards.getCurrentBoard(),t=c.spaces,r=c.links,n=!1;for(var p in r){var s=t[p],T=r[p];if(Array.isArray(T)){for(var D=0;D<T.length;)H(s,t[T[D]],e,a)?(T.splice(D,1),n=!0):D++;1===T.length?T=T[0]:T.length||delete r[p]}else H(s,t[T],e,a)&&(delete r[p],n=!0)}n&&PP64.renderer.renderConnections()}function H(e,a,c,t){return!(c>e.x&&c>a.x)&&(!(c<e.x&&c<a.x)&&(!(t>e.y&&t>a.y)&&(!(t<e.y&&t<a.y)&&$$number.lineDistance(c,t,e.x,e.y,a.x,a.y)<=4)))}function K(e){e.preventDefault()}return{attachToCanvas:function(e){e.addEventListener("contextmenu",y,!1),e.addEventListener("click",o,!1),e.addEventListener("mousedown",a,!1),e.addEventListener("mousemove",p,!1),e.addEventListener("mouseup",T,!1),e.addEventListener("mouseout",S,!1),e.addEventListener("touchstart",c,!1),e.addEventListener("touchmove",n,!1),e.addEventListener("touchend",D,!1),e.addEventListener("drop",E,!1),e.addEventListener("dragover",K,!1),e.addEventListener("keydown",P,!1)},detachFromCanvas:function(e){e.removeEventListener("contextmenu",y),e.removeEventListener("click",o),e.removeEventListener("mousedown",a),e.removeEventListener("mousemove",p),e.removeEventListener("mouseup",T),e.removeEventListener("mouseout",S),e.removeEventListener("touchstart",c),e.removeEventListener("touchmove",n),e.removeEventListener("touchend",D),e.removeEventListener("drop",E),e.removeEventListener("dragover",K),e.removeEventListener("keydown",P)}}}();
