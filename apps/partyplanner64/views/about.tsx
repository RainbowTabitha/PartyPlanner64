    ...
    if (isElectron) {
      if (this.state.foundUpdate === true) {
        ...
        electronUpdate = (
          ...
          >
            {" "}
            {this.state.updateCheckInProgress
              ? "Checking..."
              : "Check for Updates"}
          </a>
        );
    ...
    return (
      <div id="aboutForm">
        <div className="aboutHeader">
          ...
          <br />
          <span className="aboutVersion selectable">
            Version{" "}
            <span dangerouslySetInnerHTML={{ __html: versionNum }}></span>
          </span>
          {isElectron && <br />}
          {electronUpdate}
        </div>
        ...
        <div className="aboutText">
          ...
          <ul>
            <li>
              Follow{" "}
              <a
                href="https://twitter.com/PartyPlanner64"
                target="_blank"
            ...
            <li>
              <a
                href="https://github.com/PartyPlanner64/PartyPlanner64"
                target="_blank"
                rel="noopener noreferrer"
              >
                Contribute
              </a>{" "}
              to development on Github.
            </li>
            <li>
              Write or view{" "}
              <a
            ...
            <li>
              Read the{" "}
              <a
                href="https://github.com/PartyPlanner64/PartyPlanner64/wiki/Creating-a-Board"
                target="_blank"
                rel="noopener noreferrer"
              >
                usage tutorial
              ...
              or{" "}
              <a
                href="https://github.com/PartyPlanner64/PartyPlanner64/wiki"
                rel="noopener noreferrer"
              >
                documentation
              </a>
        ...
        <div className="aboutHeader">
          ...
          <br />
          <a
            href="http://mariopartylegacy.com/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img src={mpllogoImage} alt="Mario Party Legacy" />
          </a>
        </div>
        <div className="aboutText">
          <ul>
            <li>
              Check out discussion in the{" "}
              <a
                href="https://discord.gg/BQMuUpM"
                target="_blank"
                rel="noopener noreferrer"
              >
                discord chat
            ...
            <li>
              Post your creations to the{" "}
              <a
                href="http://www.mariopartylegacy.com/forum/index.php?action=downloads"
                target="_blank"
                rel="noopener noreferrer"
              >
                downloads page
        ...
        <div className="aboutHeader">
          ...
          <a
            href="https://teespring.com/stores/partyplanner64"
            target="_blank"
            rel="noopener"
          >
            <div className="aboutShirt">
              <img
                src={shirtImage}
                alt="PartyPlanner64 merchandise"
                className="aboutShirtImg"
              />
        ...
        <br />
        <br />
        <span className="aboutDisclaimer">
          PartyPlanner64 is not affiliated with Nintendo or Hudson.
        </span>
        <br />
        <span className="aboutDisclaimer">
          Mario Party is a registered trademark of Nintendo.
        </span>
      </div>
    );
  }
