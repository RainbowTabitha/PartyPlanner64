...
export default function SmallerC(opts?: Partial<EmscriptenModule>): Promise<EmscriptenModule>;
...
declare namespace FS {
  ...
  function createDataFile(parent: string | FSNode, name: string, data: string, canRead: boolean, canWrite: boolean): FSNode;
