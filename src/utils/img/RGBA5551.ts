...
export function RGBA5551toRGBA32(buffer: ArrayBuffer, width: number, height: number) {
...
export function RGBA5551fromRGBA32(buffer: ArrayBuffer, width: number, height: number) {
