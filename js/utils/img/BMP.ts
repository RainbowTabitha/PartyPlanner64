namespace PP64.utils.img {
  ...
  export const BMP = class BMP {
    static toRGBA(buffer: ArrayBuffer | DataView, palette: number[], inBpp: number, outBpp: number) {
      let inView = buffer;
    ...
    static fromRGBA(buffer: ArrayBuffer | DataView, inBpp: number, outBpp: number): [ArrayBuffer, IPaletteInfo] {
