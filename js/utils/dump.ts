...
export function saveWaluigi() {
  if (romhandler.getGameVersion() !== 3)
    throw `Waluigi is not in game ${romhandler.getGameVersion()}`;
...
export function writeWaluigi(character = 1) {
  if (romhandler.getGameVersion() !== 1)
    throw `Waluigi cannot write to MP${romhandler.getGameVersion()}`;
...
export function saveDaisy() {
  if (romhandler.getGameVersion() !== 3)
    throw `Daisy is not in game ${romhandler.getGameVersion()}`;
...
export function writeDaisy(character = 6) {
  if (romhandler.getGameVersion() !== 1)
    throw `Daisy cannot write to MP${romhandler.getGameVersion()}`;
