namespace PP64.adapters {
  ...
  export class SpaceEventList {
    ...
    */
    ...
    _writeEntry(dataView: DataView, currentOffset: number,
      ...
      executionType: PP64.types.EventExecutionType, address: number = 0)
    {
    ...
    add(activationType: PP64.types.EventActivationType,
      executionType: PP64.types.EventExecutionType, address: number = 0)
    {
  ...
  export class SpaceEventListEntry {
    public activationType: PP64.types.EventActivationType;
    public executionType: PP64.types.EventExecutionType;
    public address: number;

    constructor(activationType: PP64.types.EventActivationType,
      executionType: PP64.types.EventExecutionType, address: number)
    {
